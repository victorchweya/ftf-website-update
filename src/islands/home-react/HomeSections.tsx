...
function AboutUs() {
  return (
    <div className="content-stretch flex gap-[2px] items-center justify-center p-[8px] relative shrink-0" data-name="about-us">
      <p className="font-['Rubik:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[16px] text-black text-center whitespace-nowrap">Buy from us</p>
...
function Sell() {
  return (
    <div className="content-stretch flex items-start px-[16px] py-[8px] relative rounded-[40px] shrink-0" data-name="sell">
      <p className="font-['Rubik:Regular',sans-serif] leading-[1.68] not-italic relative shrink-0 text-[16px] text-black text-center tracking-[0.48px] whitespace-nowrap">Sell with us</p>
    </div>
  );
}
...
function Solution() {
  return (
    <div className="content-stretch flex items-start p-[8px] relative shrink-0" data-name="solution">
      <p className="font-['Rubik:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[16px] text-black text-center whitespace-nowrap">Our Impact</p>
    </div>
  );
}
...
function AboutUs1() {
  return (
    <div className="content-stretch flex gap-[2px] items-center justify-center p-[8px] relative shrink-0" data-name="about-us">
      <p className="font-['Rubik:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[16px] text-black text-center whitespace-nowrap">About us</p>
      <div className="overflow-clip relative shrink-0 size-[20px]" data-name="chevron-down">
        <div className="absolute bottom-[37.5%] left-1/4 right-1/4 top-[37.5%]" data-name="Icon">
          <div className="absolute inset-[-20%_-10%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 7">
...
function Order() {
  return (
    <div className="bg-[#d78228] content-stretch flex items-start px-[16px] py-[8px] relative rounded-[40px] shrink-0" data-name="order">
      <p className="font-['Rubik:Regular',sans-serif] leading-[1.68] not-italic relative shrink-0 text-[#eee] text-[16px] text-center tracking-[0.48px] whitespace-nowrap">Log In</p>
    </div>
  );
}
...
function Frame17() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute content-stretch flex flex-col gap-[30px] items-center left-1/2 not-italic text-center top-[calc(50%-271px)] w-[666px]">
      <p className="font-['Fraunces:Regular',sans-serif] leading-[normal] relative shrink-0 text-[#1e4a35] text-[64px] tracking-[1.92px] w-[544px]">Shaping the Future of Food</p>
      <p className="font-['Rubik:Regular',sans-serif] leading-[1.68] min-w-full relative shrink-0 text-[#d78228] text-[20px] tracking-[0.6px] w-[min-content]">Connecting farmers, markets, and ingredients through smarter supply chains.</p>
    </div>
  );
}
...
function Order1() {
  return (
    <div className="bg-[#1e4a35] col-1 content-stretch flex items-start ml-[99px] mt-[367px] px-[16px] py-[8px] relative rounded-[40px] row-1" data-name="order">
      <p className="font-['Rubik:Regular',sans-serif] leading-[1.68] not-italic relative shrink-0 text-[#eee] text-[16px] text-center tracking-[0.48px] whitespace-nowrap">Sell with us</p>
    </div>
  );
}
...
function Frame25() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-center not-italic relative shrink-0 text-center w-full">
      <div className="font-['Fraunces:Regular',sans-serif] leading-[0] relative shrink-0 text-[#0f251b] text-[24px] tracking-[0.72px] whitespace-nowrap">
        <p className="leading-[normal] mb-0 whitespace-pre">{`For Kenyan `}</p>
        <p className="leading-[normal] whitespace-pre">Farmers</p>
      </div>
      <p className="font-['Rubik:Regular',sans-serif] leading-[1.68] min-w-full relative shrink-0 text-[#1e4a35] text-[16px] tracking-[0.48px] w-[min-content]">The future of food starts with you</p>
    </div>
  );
}
...
function Order2() {
  return (
    <div className="bg-[#1e4a35] col-1 content-stretch flex items-start ml-[83px] mt-[363px] px-[16px] py-[8px] relative rounded-[40px] row-1" data-name="order">
      <p className="font-['Rubik:Regular',sans-serif] leading-[1.68] not-italic relative shrink-0 text-[16px] text-center text-white tracking-[0.48px] whitespace-nowrap">Buy from us</p>
    </div>
  );
}
...
function Frame28() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-center not-italic relative shrink-0 text-center w-full">
      ...
      <p className="font-['Rubik:Regular',sans-serif] leading-[1.68] min-w-full relative shrink-0 text-[#1e4a35] text-[16px] tracking-[0.48px] w-[min-content]">The future of food, delivered to you</p>
    </div>
  );
}
...
function Order3() {
  return (
    <div className="bg-[#1e4a35] col-1 content-stretch flex items-start ml-[92px] mt-[366px] px-[16px] py-[8px] relative rounded-[40px] row-1" data-name="order">
      <p className="font-['Rubik:Regular',sans-serif] leading-[1.68] not-italic relative shrink-0 text-[16px] text-center text-white tracking-[0.48px] whitespace-nowrap">Learn more</p>
    </div>
  );
}
...
function Frame30() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-center not-italic relative shrink-0 text-center w-full">
      ...
      <p className="font-['Rubik:Regular',sans-serif] leading-[1.68] min-w-full relative shrink-0 text-[#1e4a35] text-[16px] tracking-[0.48px] w-[min-content]">The future of food, supplied from Kenya</p>
    </div>
  );
}
...
function Order4() {
  return (
    <div className="bg-[#1e4a35] content-stretch flex items-start px-[24px] py-[12px] relative rounded-[40px] shrink-0" data-name="order">
      <p className="font-['Rubik:Regular',sans-serif] leading-[1.68] not-italic relative shrink-0 text-[16px] text-center text-white tracking-[0.48px] whitespace-nowrap">Read Impact Report 2025</p>
    </div>
  );
}
...
function Frame32() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[52px] items-center left-[calc(8.33%+74px)] top-[101px] w-[1052px]">
      <div className="font-['Fraunces:Regular',sans-serif] leading-[0] min-w-full not-italic relative shrink-0 text-[#0f251b] text-[40px] text-center tracking-[1.2px] w-[min-content]">
      ...
      <div className="font-['Rubik:Regular',sans-serif] leading-[0] not-italic relative shrink-0 text-[#1e4a35] text-[16px] text-center tracking-[0.48px] w-[592px] whitespace-pre-wrap">
...
function Content1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] items-start justify-center min-w-px not-italic overflow-clip relative" data-name="Content">
      <p className="font-['Fraunces:Medium',sans-serif] leading-[1.4] relative shrink-0 text-[#0f251b] text-[32px] w-full">Better Markets for Farmers</p>
      <p className="font-['Rubik:Regular',sans-serif] leading-[28px] relative shrink-0 text-[#1e4a35] text-[18px] w-full">We connect farmers to reliable buyers, turning harvests into stable income and reducing unnecessary food loss.</p>
    </div>
  );
}
...
function Content2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] items-start justify-center min-w-px not-italic overflow-clip relative" data-name="Content">
      <p className="font-['Fraunces:Medium',sans-serif] leading-[1.4] relative shrink-0 text-[#0d0d0d] text-[32px] w-full">Better Sourcing for Businesses</p>
      <p className="font-['Rubik:Regular',sans-serif] leading-[28px] relative shrink-0 text-[#1e4a35] text-[18px] w-full">{`Hotels, caterers, processors, and global buyers access quality produce and ingredients with full transparency and consistent supply. `}</p>
    </div>
  );
}
...
function Content3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] items-start justify-center min-w-px not-italic overflow-clip relative" data-name="Content">
      <p className="font-['Fraunces:Medium',sans-serif] leading-[1.4] relative shrink-0 text-[#0d0d0d] text-[32px] w-full">Better Food Systems for Everyone</p>
      <p className="font-['Rubik:Regular',sans-serif] leading-[28px] relative shrink-0 text-[#1e4a35] text-[18px] w-full">{`By efficiently matching supply and demand, we ensure more food is consumed rather than wasted. Food systems will shape our planet's future, with Africa leading the way. At Farm to Feed, we create the infrastructure for a more inclusive, resilient, and waste-free future.`}</p>
    </div>
  );
}
...
function Order5() {
  return (
    <div className="bg-[#1e4a35] content-stretch flex items-start px-[16px] py-[8px] relative rounded-[40px] shrink-0" data-name="order">
      <p className="font-['Rubik:Regular',sans-serif] leading-[1.68] not-italic relative shrink-0 text-[#eee] text-[16px] text-center tracking-[0.48px] whitespace-nowrap">Learn More</p>
    </div>
  );
}
...
function Frame33() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex flex-col gap-[64px] items-center left-1/2 top-[615px] w-[822px]">
      <p className="font-['Fraunces:Regular',sans-serif] leading-[normal] min-w-full not-italic relative shrink-0 text-[#0f251b] text-[40px] text-center tracking-[1.2px] w-[min-content]">We produce excellence for all actors in the supply chain, from farmer to customer</p>
      <Order5 />
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start not-italic relative shrink-0 w-full">
      <p className="font-['Fraunces:Regular',sans-serif] leading-[normal] relative shrink-0 text-[#4c352b] text-[64px] tracking-[1.92px] w-full">1K</p>
      <p className="font-['Rubik:Regular',sans-serif] leading-[1.68] relative shrink-0 text-[#7b6a62] text-[16px] tracking-[0.48px] w-full">tonnes of CO2e avoided</p>
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start not-italic relative shrink-0 w-full">
      <p className="font-['Fraunces:Regular',sans-serif] leading-[normal] relative shrink-0 text-[#4c352b] text-[64px] tracking-[1.92px] w-full">920K</p>
      <p className="font-['Rubik:Regular',sans-serif] leading-[1.68] relative shrink-0 text-[#7b6a62] text-[16px] tracking-[0.48px] w-full">KG of food saved</p>
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start not-italic relative shrink-0 w-full">
      <p className="font-['Fraunces:Regular',sans-serif] leading-[normal] relative shrink-0 text-[#4c352b] text-[64px] tracking-[1.92px] w-full">37%</p>
      <p className="font-['Rubik:Regular',sans-serif] leading-[1.68] relative shrink-0 text-[#7b6a62] text-[16px] tracking-[0.48px] w-full">increase in farmers’ incomes</p>
    </div>
  );
}
...
function Frame18() {
  return (
    <div className="bg-[#f9ecbd] h-[771px] overflow-clip relative shrink-0 w-[1440px]">
      ...
      <Frame20 />
      <Frame21 />
      <p className="absolute font-['Fraunces:Regular',sans-serif] leading-[1.42] left-[calc(8.33%+3px)] not-italic text-[#4c352b] text-[32px] top-[325px] tracking-[0.96px] w-[368px]">By keeping food in the human food supply chain, we have an impact on various levels:</p>
      ...
      <div className="absolute flex inset-[94.81%_0_0_0] items-center justify-center" style={{ containerType: "size" }}>
        <div className="-scale-x-100 flex-none" style={{ height: "100cqh", width: "100cqw" }}>
          <Group36 />
        </div>
      </div>
    </div>
...
function TaglineWrapper() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Tagline Wrapper">
      <p className="font-['Rubik:Regular',sans-serif] leading-[28px] not-italic relative shrink-0 text-[#b3b3b3] text-[18px] whitespace-nowrap">News Stories</p>
    </div>
  );
}
...
function Content4() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="Content">
      <p className="font-['Fraunces:Regular',sans-serif] leading-[1.2] not-italic relative shrink-0 text-[48px] text-black w-full">Check out our latest News!</p>
    </div>
  );
}
...
function Order6() {
  return (
    <div className="bg-[#1e4a35] content-stretch flex items-start px-[16px] py-[8px] relative rounded-[40px] shrink-0" data-name="order">
      <p className="font-['Rubik:Regular',sans-serif] leading-[1.68] not-italic relative shrink-0 text-[#eee] text-[16px] text-center tracking-[0.48px] whitespace-nowrap">View All</p>
    </div>
  );
}
...
function Info() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Info">
      <p className="font-['Rubik:Medium',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#1e4a35] text-[14px] whitespace-nowrap">09 Jan 2026</p>
    </div>
  );
}
...
function Content7() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Content">
      <p className="font-['Fraunces:Regular',sans-serif] leading-[32px] not-italic relative shrink-0 text-[#0f251b] text-[24px] w-full">Farm to Feed has published their first Impact Report</p>
    </div>
  );
}
...
function Button() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center relative shrink-0" data-name="Button">
      <p className="font-['Rubik:Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#916f96] text-[16px] whitespace-nowrap">Read more</p>
...
function Content10() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Content">
      <p className="font-['Fraunces:Regular',sans-serif] leading-[32px] not-italic relative shrink-0 text-[#0f251b] text-[24px] w-full">Farm to Feed Wins Global Startup Award and Secures New Investment</p>
    </div>
  );
}
...
function Content13() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Content">
      <p className="font-['Fraunces:Regular',sans-serif] leading-[32px] not-italic relative shrink-0 text-[#0f251b] text-[24px] w-full">Farm to Feed Expands Operations to New Region</p>
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="content-stretch flex flex-col gap-[14px] items-start leading-[1.68] not-italic relative shrink-0 w-full">
      <p className="font-['Rubik:Regular',sans-serif] relative shrink-0 text-[20px] text-white tracking-[0.6px] whitespace-nowrap">Quick Actions</p>
      <p className="font-['Rubik:Light',sans-serif] relative shrink-0 text-[#dfeddf] text-[16px] tracking-[0.48px] w-[379px]">Buy or Sell produce that makes sense for your business and the planet</p>
    </div>
  );
}
...
function Order7() {
  return (
    <div className="bg-[#eff6ef] content-stretch flex items-start px-[24px] py-[12px] relative rounded-[40px] shrink-0" data-name="order">
      <p className="font-['Rubik:Regular',sans-serif] leading-[1.68] not-italic relative shrink-0 text-[#1e4a35] text-[16px] text-center tracking-[0.48px] whitespace-nowrap">Sell With Us</p>
    </div>
  );
}
...
function Order8() {
  return (
    <div className="bg-[#d78228] content-stretch flex items-start px-[24px] py-[12px] relative rounded-[40px] shrink-0" data-name="order">
      <p className="font-['Rubik:Regular',sans-serif] leading-[1.68] not-italic relative shrink-0 text-[#eff6ef] text-[16px] text-center tracking-[0.48px] whitespace-nowrap">Log In</p>
    </div>
  );
}
...
function Frame9() {
  return (
    <div className="content-stretch flex flex-col gap-[14px] h-[75px] items-start leading-[1.68] not-italic relative shrink-0 w-full">
      <p className="font-['Rubik:Regular',sans-serif] relative shrink-0 text-[20px] text-white tracking-[0.6px] whitespace-nowrap">Get more information</p>
      <p className="font-['Rubik:Light',sans-serif] relative shrink-0 text-[#dfeddf] text-[16px] tracking-[0.48px] w-[379px]">Contact us in any of these channels</p>
    </div>
  );
}
...
function Frame11() {
  return (
    <div className="content-stretch flex gap-[16px] items-start relative shrink-0">
      <PrimeEnvelope />
      <p className="font-['Rubik:Light',sans-serif] leading-[1.68] not-italic relative shrink-0 text-[16px] text-white tracking-[0.48px] whitespace-nowrap">info@farmtofeedkenya.com</p>
    </div>
  );
}
...
function Frame12() {
  return (
    <div className="content-stretch flex gap-[16px] items-start relative shrink-0 w-full">
      <PrimePhone />
      <p className="flex-[1_0_0] font-['Rubik:Light',sans-serif] leading-[1.68] min-w-px not-italic relative text-[16px] text-white tracking-[0.48px]">+254 795 851 756</p>
    </div>
  );
}
...
function Frame13() {
  return (
    <div className="content-stretch flex gap-[16px] items-start relative shrink-0">
      <PrimeMapMarker />
      <p className="font-['Rubik:Light',sans-serif] leading-[1.68] not-italic relative shrink-0 text-[16px] text-white tracking-[0.48px] whitespace-nowrap">Tilisi Business Park, Kiambu, Kenya</p>
    </div>
  );
}
...
function Solution1() {
  return (
    <div className="content-stretch flex items-start p-[8px] relative shrink-0" data-name="solution">
      <p className="font-['Rubik:Regular',sans-serif] leading-[1.68] not-italic relative shrink-0 text-[16px] text-center text-white tracking-[0.48px] whitespace-nowrap">Kenyan Buyers</p>
    </div>
  );
}
...
function AboutUs2() {
  return (
    <div className="content-stretch flex items-center justify-center p-[8px] relative shrink-0" data-name="about-us">
      <p className="font-['Rubik:Regular',sans-serif] leading-[1.68] not-italic relative shrink-0 text-[16px] text-center text-white tracking-[0.48px] whitespace-nowrap">Global Buyers</p>
    </div>
  );
}
...
function AboutUs3() {
  return (
    <div className="content-stretch flex items-center justify-center p-[8px] relative shrink-0" data-name="about-us">
      <p className="font-['Rubik:Regular',sans-serif] leading-[1.68] not-italic relative shrink-0 text-[16px] text-center text-white tracking-[0.48px] whitespace-nowrap">Careers</p>
    </div>
  );
}
...
function AboutUs4() {
  return (
    <div className="content-stretch flex items-center justify-center p-[8px] relative shrink-0" data-name="about-us">
      <p className="font-['Rubik:Regular',sans-serif] leading-[1.68] not-italic relative shrink-0 text-[16px] text-center text-white tracking-[0.48px] whitespace-nowrap">Contact Us</p>
    </div>
  );
}
...
function AboutUs5() {
  return (
    <div className="content-stretch flex items-center justify-center p-[8px] relative shrink-0" data-name="about-us">
      <p className="font-['Rubik:Regular',sans-serif] leading-[1.68] not-italic relative shrink-0 text-[16px] text-center text-white tracking-[0.48px] whitespace-nowrap">FAQs</p>
    </div>
  );
}
...
function Frame15() {
  return (
    <div className="content-stretch flex flex-col gap-[14px] items-start relative shrink-0 w-full">
      <p className="font-['Rubik:Regular',sans-serif] leading-[1.68] not-italic relative shrink-0 text-[20px] text-white tracking-[0.6px] whitespace-nowrap">Explore</p>
      <Frame22 />
    </div>
  );
}
...
function AboutUs6() {
  return (
    <div className="content-stretch flex items-center justify-center p-[8px] relative shrink-0" data-name="about-us">
      <p className="font-['Rubik:Regular',sans-serif] leading-[1.68] not-italic relative shrink-0 text-[16px] text-center text-white tracking-[0.48px] whitespace-nowrap">Privacy Policy</p>
    </div>
  );
}
...
function AboutUs7() {
  return (
    <div className="content-stretch flex items-center justify-center p-[8px] relative shrink-0" data-name="about-us">
      <p className="font-['Rubik:Regular',sans-serif] leading-[1.68] not-italic relative shrink-0 text-[16px] text-center text-white tracking-[0.48px] whitespace-pre">{`Cookie  Policy`}</p>
    </div>
  );
}
...
function AboutUs8() {
  return (
    <div className="absolute content-stretch flex items-center justify-end left-[calc(75%+37px)] p-[8px] top-[542px]" data-name="about-us">
      <p className="font-['Rubik:Regular',sans-serif] leading-[1.68] not-italic relative shrink-0 text-[16px] text-right text-white tracking-[0.48px] whitespace-nowrap">©2026 All right reserved</p>
    </div>
  );
}
...
function SectionShell({ children, className = "" }: { children: React.ReactNode; className?: string }) {
  return (
    <section className={`flex w-full justify-center overflow-hidden ${className}`}>
      {children}
    </section>
  );
}
...
export default function Home() {
  return (
    <div className="bg-white content-stretch flex w-full flex-col items-stretch relative" data-name="home">
      <SectionShell className="bg-[#fbf3e9]">
        <Hero />
      </SectionShell>
      <SectionShell className="bg-[#fbf3e9]">
        <Wireframe1 />
      </SectionShell>
      <SectionShell className="bg-[#dae2b6]">
        <Layout />
      </SectionShell>
      <SectionShell className="bg-white">
        <Wireframe />
      </SectionShell>
      <SectionShell className="bg-[#f9ecbd]">
        <Frame18 />
      </SectionShell>
      <SectionShell className="bg-[#fbfafa]">
        <News />
      </SectionShell>
    </div>
  );
