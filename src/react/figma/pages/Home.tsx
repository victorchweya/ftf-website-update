...
import imgVector from "../../../assets/figma/e633ceac9ddc9469f55691764eff36cd0be98620.png?url";
	...
	return (
		<div className="-translate-x-1/2 -translate-y-1/2 absolute content-stretch flex flex-col gap-[30px] items-center left-1/2 max-w-[666px] not-italic text-center top-[calc(50%-271px)] w-[calc(100%-2.5rem)] sm:w-[calc(100%-4rem)] lg:w-[calc(100%-5rem)]">
			...
			<p className="font-['Rubik',sans-serif] font-normal leading-[1.68] min-w-full relative shrink-0 text-[#d78228] text-[20px] tracking-[0.6px] w-[min-content]">
				Connecting farmers, markets, and ingredients through smarter
				supply chains.
			</p>
		</div>
	);
	...
	return (
		<div className="h-[154px] relative shrink-0 w-[158px]">
			<svg
				...
				<g id="Group 302">
					<path
						d={svgPaths.p1ed68a00}
						fill="var(--fill-0, #707ABE)"
						id="Vector"
					/>
					<g id="Vector_2">
						<path
							d={svgPaths.p15d84300}
							fill="var(--fill-0, #E8EAFC)"
						/>
						<path
							d={svgPaths.p3f5cad80}
							fill="var(--fill-0, #E8EAFC)"
						/>
						<path
							d={svgPaths.p26303400}
							fill="var(--fill-0, #E8EAFC)"
						/>
						<path
							d={svgPaths.p21682000}
							fill="var(--fill-0, #E8EAFC)"
						/>
						<path
							d={svgPaths.pa76d900}
						...
						/>
						<path
							d={svgPaths.p31d2fd00}
							fill="var(--fill-0, #E8EAFC)"
						/>
						<path
							d={svgPaths.p2bfe0100}
							fill="var(--fill-0, #E8EAFC)"
						/>
					</g>
				</g>
				...
				<div className="absolute inset-[-1.34%_-7.92%_-14.77%_-7.92%]">
					<svg
						...
						<g filter="url(#filter0_d_1_1595)" id="Vector">
							<path
								d={svgPaths.p1a984d00}
								fill="var(--fill-0, white)"
							/>
							<path
								d={svgPaths.p1cb35680}
						...
						<defs>
							<filter
								...
								<feBlend
									...
									mode="normal"
									result="effect1_dropShadow_1_1595"
								/>
								<feBlend
									in="SourceGraphic"
									in2="effect1_dropShadow_1_1595"
									mode="normal"
									result="shape"
								/>
							</filter>
	...
	return (
		<div
			...
			<svg
				...
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 158.083 154">
				<g id="Group">
					<path
						d={svgPaths.p1d721980}
	...
	return (
		<div
			...
			<svg
				...
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 81.741 79.2259">
				<g clipPath="url(#clip0_1_1551)" id="Capa_1">
					<path
						d={svgPaths.p1e1fa900}
						fill="var(--fill-0, white)"
						id="Vector"
					/>
					<path
						d={svgPaths.p247d79f2}
						fill="var(--fill-0, white)"
						id="Vector_2"
					/>
					<path
						d={svgPaths.p22605600}
						fill="var(--fill-0, white)"
						id="Vector_3"
					/>
				</g>
		...
		<div className="h-[154px] relative shrink-0 w-[158px]">
			<svg
				...
				<g id="Group 301">
					...
					<g id="Group 300">
						<path
							d={svgPaths.p2aa73900}
							fill="var(--fill-0, white)"
							id="Vector_2"
						/>
						<path
							d={svgPaths.p2e45de00}
							fill="var(--fill-0, white)"
							id="Vector_3"
						/>
						<path
							d={svgPaths.p3f69de00}
							fill="var(--fill-0, white)"
							id="Vector_4"
						/>
						<path
							d={svgPaths.p2e085900}
							fill="var(--fill-0, white)"
							id="Vector_5"
						/>
					</g>
		...
		<div className="-translate-x-1/2 absolute content-stretch flex flex-col gap-[52px] items-center left-1/2 max-w-[1052px] top-[101px] w-[calc(100%-2.5rem)] sm:w-[calc(100%-4rem)] lg:w-[calc(100%-5rem)]">
			<div className="font-['Fraunces',serif] font-normal leading-[0] min-w-full not-italic relative shrink-0 text-[#0f251b] text-[40px] text-center tracking-[1.2px] w-[min-content]">
				<p className="leading-[normal] mb-0">
					...
					a better supply chain. One that works for
				</p>
				<p className="leading-[normal]">
					farmers, businesses, and the planet alike.
				</p>
			</div>
			<div className="font-['Rubik',sans-serif] font-normal leading-[0] max-w-[592px] not-italic relative shrink-0 text-[#1e4a35] text-[16px] text-center tracking-[0.48px] w-full whitespace-pre-wrap">
				<p className="leading-[1.68] mb-0">
					...
					vegetables go to waste - driving emissions, hurting farmers,
					and weakening food security. Meanwhile, buyers face
					unreliable supply, high costs, and poor traceability.
				</p>
				<p className="leading-[1.68] mb-0">​</p>
				<p className="leading-[1.68]">
					Since 2021, Farm to Feed, a women-led Kenyan startup has
					been closing this gap. We rescue imperfect and surplus
					produce, extend shelf life, and connect farmers to fair,
					reliable markets while offering buyers a seamless platform
					to source fresh, traceable, and affordable food with
					confidence.
				</p>
			</div>
			<Order4 />
				...
				<div className="-scale-x-100 flex-none h-[100cqw] rotate-90 w-[100cqh]">
					<div className="relative size-full" data-name="Vector">
						<svg
							...
							fill="none"
							preserveAspectRatio="none"
							viewBox="0 0 509.198 1933">
							<path
								d={svgPaths.p25bc3000}
								fill="var(--fill-0, #DAE2B6)"
								id="Vector"
							/>
						</svg>
					</div>
...
function Content1() {
	return (
		<div
			className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] items-start justify-center min-w-px not-italic overflow-clip relative"
			data-name="Content">
			<p className="font-['Fraunces',serif] font-medium leading-[1.4] relative shrink-0 text-[#0f251b] text-[32px] w-full">
				Better Markets for Farmers
			</p>
			<p className="font-['Rubik',sans-serif] font-normal leading-[28px] relative shrink-0 text-[#1e4a35] text-[18px] w-full">
				We connect farmers to reliable buyers, turning harvests into
				stable income and reducing unnecessary food loss.
			</p>
		</div>
	);
}
...
function Content2() {
	return (
		<div
			className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] items-start justify-center min-w-px not-italic overflow-clip relative"
			data-name="Content">
			<p className="font-['Fraunces',serif] font-medium leading-[1.4] relative shrink-0 text-[#0d0d0d] text-[32px] w-full">
...
function TabsMenu() {
	return (
		<div
			className="content-stretch flex flex-col h-[543px] items-center justify-between relative shrink-0 w-[579px]"
			data-name="Tabs Menu">
			<TabHorizontal />
			<TabHorizontal1 />
			<TabHorizontal2 />
...
function Content() {
	return (
		<div
			className="content-stretch flex gap-[80px] items-center relative shrink-0 w-full"
			data-name="Content">
			<TabsMenu />
			<div
				className="absolute flex h-[555.649px] items-center justify-center left-[699.82px] top-[61.68px] w-[574.366px]"
				style={
					{
						"--transform-inner-width": "1185",
						"--transform-inner-height": "21",
			...
			<div
				className="h-[552px] relative shrink-0 w-[517px]"
				data-name="Vector">
				<img
					alt=""
					className="absolute block inset-0 max-w-none size-full"
...
function SupplyChainBenefitsSection() {
	return (
		<div
			className="bg-[#dae2b6] overflow-clip pb-[112px] pt-[64px] relative shrink-0 w-full"
			data-name="Layout / 28 /">
		...
		<div
			...
			<div className="absolute inset-[0_0_-0.25%_0]">
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 70.2154 156.219">
					<g id="Group">
						<path
							d={svgPaths.p68406d0}
							id="Vector"
							stroke="var(--stroke-0, #4C352B)"
							strokeMiterlimit="10"
							strokeWidth="5"
						/>
						<path
							d={svgPaths.p114abb80}
							id="Vector_2"
							stroke="var(--stroke-0, #4C352B)"
							strokeMiterlimit="10"
							strokeWidth="5"
						...
						/>
						<path
							d={svgPaths.p24117800}
							fill="var(--fill-0, #7B6A62)"
							id="Vector_11"
						/>
						<path
							d={svgPaths.p3bd4cc80}
							fill="var(--fill-0, #7B6A62)"
							id="Vector_12"
						/>
						<path
						...
						/>
						<path
							d={svgPaths.p3b8e8c00}
							fill="var(--fill-0, #7B6A62)"
							id="Vector_16"
						/>
						<path
							d={svgPaths.p1ff84140}
							fill="var(--fill-0, #7B6A62)"
							id="Vector_17"
						/>
						<path
							d={svgPaths.p39595e80}
							fill="var(--fill-0, #7B6A62)"
							id="Vector_18"
						/>
					</g>
		...
		<div
			...
			<svg
				...
				<g id="Group">
					...
					/>
					<path
						d={svgPaths.p1aef5000}
						fill="var(--fill-0, #4C352B)"
						id="Vector_2"
					/>
					<path
						d={svgPaths.p2a82cb00}
						fill="var(--fill-0, #4C352B)"
						id="Vector_3"
					/>
					<path
						d={svgPaths.p28201800}
						fill="var(--fill-0, #4C352B)"
						id="Vector_4"
					/>
					<path
						d={svgPaths.p213ac200}
						fill="var(--fill-0, #4C352B)"
						id="Vector_5"
					/>
					<path
						d={svgPaths.p3e6a2e00}
						fill="var(--fill-0, #4C352B)"
						id="Vector_6"
					/>
					<path
						d={svgPaths.p2f087d00}
						fill="var(--fill-0, #4C352B)"
						id="Vector_7"
					/>
					<path
					...
					/>
					<path
						d={svgPaths.p38624b00}
						fill="var(--fill-0, #4C352B)"
						id="Vector_10"
					/>
					<path
						d={svgPaths.p1c344f00}
						fill="var(--fill-0, #4C352B)"
						id="Vector_11"
					/>
					<path
					...
					/>
					<path
						d={svgPaths.p1f5c5000}
						fill="var(--fill-0, #4C352B)"
						id="Vector_13"
					/>
					<path
						d={svgPaths.p21464d00}
						fill="var(--fill-0, #4C352B)"
						id="Vector_14"
					/>
					<path
					...
					/>
					<path
						d={svgPaths.p289a3bc0}
						fill="var(--fill-0, #4C352B)"
						id="Vector_16"
					/>
					<path
						d={svgPaths.p2b147d80}
						fill="var(--fill-0, #4C352B)"
						id="Vector_17"
					/>
					<path
						d={svgPaths.p257d1900}
						fill="var(--fill-0, #4C352B)"
						id="Vector_18"
					/>
					<path
					...
					/>
					<path
						d={svgPaths.p338aa3c0}
						fill="var(--fill-0, #4C352B)"
						id="Vector_20"
					/>
					<path
						d={svgPaths.p39c2cf80}
						fill="var(--fill-0, #4C352B)"
						id="Vector_21"
					/>
				</g>
...
function Group8() {
	return (
		<div
			...
			style={{ maskImage: `url('${imgVector2}'), url('${imgGroup1}')` }}
			data-name="Group">
			<svg
				className="absolute block inset-0 size-full"
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 184.539 170.225">
				<g id="Group">
					<path
						d={svgPaths.pbf3b00}
						fill="var(--fill-0, #F2D4B0)"
						id="Vector"
					/>
					<path
						d={svgPaths.p395f600}
					...
					/>
					<path
						d={svgPaths.p10f19f00}
						fill="var(--fill-0, #4C352B)"
						id="Vector_3"
					/>
					<path
						d={svgPaths.p2aeee5f0}
						fill="var(--fill-0, #4C352B)"
						id="Vector_4"
					/>
					<path
						d={svgPaths.p31fde700}
						fill="var(--fill-0, #4C352B)"
						id="Vector_5"
					/>
				</g>
...
function Group10() {
	return (
		<div
			...
			style={{ maskImage: `url('${imgVector2}'), url('${imgGroup2}')` }}
			data-name="Group">
			<svg
				className="absolute block inset-0 size-full"
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 36.8649 27.5726">
				<g id="Group">
					<path
						d={svgPaths.p126fbd80}
						fill="var(--fill-0, #4C352B)"
						id="Vector"
					/>
					<path
						d={svgPaths.paf8c500}
						fill="var(--fill-0, #F5DF91)"
						id="Vector_2"
					/>
				</g>
			</svg>
		...
		<div
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 220.598 184.902">
					<path
						d={svgPaths.p1a98fd80}
						fill="var(--fill-0, #4C352B)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 35.6622 26.7116">
					<path
						d={svgPaths.p19d2af80}
						fill="var(--fill-0, #4C352B)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 31.7885 26.7116">
					<path
						d={svgPaths.p1805ed80}
						fill="var(--fill-0, #4C352B)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 39.4109 26.7116">
					<path
						d={svgPaths.p2ff3d580}
						fill="var(--fill-0, #4C352B)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 5.98903 11.6349">
					<path
						d={svgPaths.p1e04aff0}
						fill="var(--fill-0, #F5DF91)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 5.97122 11.6349">
					<path
						d={svgPaths.p314ea500}
						fill="var(--fill-0, #F5DF91)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 5.97122 10.7917">
					<path
						d={svgPaths.p3d7e0700}
						fill="var(--fill-0, #F5DF91)"
						id="Vector"
					/>
				</svg>
...
function Group15() {
	return (
		<div
			...
			style={{ maskImage: `url('${imgVector3}'), url('${imgGroup3}')` }}
			data-name="Group">
			<svg
				className="absolute block inset-0 size-full"
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 88.2071 81.3593">
				<g id="Group">
					<path
						d={svgPaths.p2b491500}
						fill="var(--fill-0, #F2D4B0)"
						id="Vector"
					/>
					<path
						d={svgPaths.p15cf8300}
						fill="var(--fill-0, #DFAF62)"
						id="Vector_2"
					/>
					<path
						d={svgPaths.p1ea044f0}
						fill="var(--fill-0, #4C352B)"
						id="Vector_3"
					/>
					<path
						d={svgPaths.p3a2d9700}
						fill="var(--fill-0, #4C352B)"
						id="Vector_4"
					/>
					<path
						d={svgPaths.p304b6d70}
						fill="var(--fill-0, #4C352B)"
						id="Vector_5"
					/>
				</g>
...
function Group16() {
	return (
		<div
			...
			style={{ maskImage: `url('${imgVector3}'), url('${imgGroup4}')` }}
			data-name="Group">
			<svg
				className="absolute block inset-0 size-full"
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 10.3448 6.8502">
				<g id="Group">
					<path
						d={svgPaths.pa68ba00}
						fill="var(--fill-0, #4C352B)"
					...
					/>
					<path
						d={svgPaths.p3c8cc580}
						fill="var(--fill-0, #4C352B)"
						id="Vector_2"
					/>
					<path
						d={svgPaths.p26497a80}
						fill="var(--fill-0, #4C352B)"
						id="Vector_3"
					/>
				</g>
	...
	return (
		<div
			...
			<div
				...
				style={{ maskImage: `url('${imgVector3}')` }}
				data-name="Vector">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 105.431 88.3701">
					<path
						d={svgPaths.p39cd4b40}
						fill="var(--fill-0, #4C352B)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 15.1936 12.7658">
					<path
						d={svgPaths.p2fbb9700}
						fill="var(--fill-0, #4C352B)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 18.8352 12.7658">
					<path
						d={svgPaths.p11033e00}
						fill="var(--fill-0, #4C352B)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 2.85396 5.56091">
					<path
						d={svgPaths.p32bcefc0}
						fill="var(--fill-0, #F5DF91)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 2.85396 5.15717">
					<path
						d={svgPaths.p235d2dc0}
						fill="var(--fill-0, #F5DF91)"
						id="Vector"
					/>
				</svg>
	...
	return (
		<div
			...
			<svg
				...
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 166.73 193.256">
				<g id="Group">
					<path
						d={svgPaths.p20224e00}
						fill="var(--fill-0, #C2CE86)"
						id="Vector"
					/>
					<path
						d={svgPaths.p1904d400}
						fill="var(--fill-0, #C2CE86)"
						id="Vector_2"
					/>
					<path
						d={svgPaths.p17a9e200}
						fill="var(--fill-0, #C2CE86)"
						id="Vector_3"
					/>
					<path
						d={svgPaths.p3c517b80}
						fill="var(--fill-0, #C2CE86)"
						id="Vector_4"
					/>
					<path
						d={svgPaths.p1df71e40}
						fill="var(--fill-0, #C2CE86)"
						id="Vector_5"
					/>
					<path
						d={svgPaths.p146a7b70}
						fill="var(--fill-0, #85A687)"
						id="Vector_6"
					/>
					<path
						d={svgPaths.p3d4abb40}
						fill="var(--fill-0, #85A687)"
						id="Vector_7"
					/>
					<path
						d={svgPaths.p3fab8c00}
						fill="var(--fill-0, #85A687)"
						id="Vector_8"
					/>
					<path
						d={svgPaths.p1ff0c480}
						fill="var(--fill-0, #85A687)"
						id="Vector_9"
					/>
					<path
						d={svgPaths.p31802400}
						fill="var(--fill-0, #85A687)"
						id="Vector_10"
					/>
					<path
					...
					/>
					<path
						d={svgPaths.p125ade00}
						fill="var(--fill-0, #85A687)"
						id="Vector_12"
					/>
					<path
						d={svgPaths.p1058c600}
						fill="var(--fill-0, #C2CE86)"
						id="Vector_13"
					/>
					<path
						d={svgPaths.p3c937400}
						fill="var(--fill-0, #85A687)"
						id="Vector_14"
					/>
					<path
						d={svgPaths.p19541f70}
						fill="var(--fill-0, #85A687)"
						id="Vector_15"
					/>
					<path
					...
					/>
					<path
						d={svgPaths.p1bdd5920}
						fill="var(--fill-0, #BF87A6)"
						id="Vector_24"
					/>
					<path
						d={svgPaths.p183377a0}
						fill="var(--fill-0, #BF87A6)"
						id="Vector_25"
					/>
					<path
						d={svgPaths.p1346ff00}
						fill="var(--fill-0, #BF87A6)"
						id="Vector_26"
					/>
					<path
						d={svgPaths.p18f39e00}
						fill="var(--fill-0, #EBC194)"
						id="Vector_27"
					/>
					<path
						d={svgPaths.p21e57500}
						fill="var(--fill-0, #F9ECBD)"
						id="Vector_28"
					/>
					<path
						d={svgPaths.p372364c0}
						fill="var(--fill-0, #F9ECBD)"
						id="Vector_29"
					/>
					<path
						d={svgPaths.p2998c500}
						fill="var(--fill-0, #F9ECBD)"
						id="Vector_30"
					/>
					<path
						d={svgPaths.p1c06a5b0}
						fill="var(--fill-0, #F9ECBD)"
						id="Vector_31"
					/>
					<path
					...
					/>
					<path
						d={svgPaths.p10bcd200}
						fill="var(--fill-0, #F5E091)"
						id="Vector_35"
					/>
					<path
						d={svgPaths.p3ecce6c0}
						fill="var(--fill-0, #F5E091)"
						id="Vector_36"
					/>
					<path
						d={svgPaths.p2f693a70}
						fill="var(--fill-0, #F5E091)"
						id="Vector_37"
					/>
					<path
						d={svgPaths.p2bd99580}
						fill="var(--fill-0, #85A687)"
						id="Vector_38"
					/>
					<path
						d={svgPaths.p30df3600}
						fill="var(--fill-0, #C2CE86)"
						id="Vector_39"
					/>
					<path
						d={svgPaths.p27a56b80}
						fill="var(--fill-0, #C2CE86)"
						id="Vector_40"
					/>
					<path
					...
					/>
					<path
						d={svgPaths.p3cbbca80}
						fill="var(--fill-0, #C2CE86)"
						id="Vector_42"
					/>
					<path
						d={svgPaths.p2c5c5600}
						fill="var(--fill-0, #C2CE86)"
						id="Vector_43"
					/>
					<path
						d={svgPaths.p10ef7800}
						fill="var(--fill-0, #4C352B)"
						id="Vector_44"
					/>
					<path
						d={svgPaths.p2bfe3300}
						fill="var(--fill-0, #9BA56B)"
						id="Vector_45"
					/>
					<path
						d={svgPaths.p1a5d0ac0}
						fill="var(--fill-0, #1E4A35)"
						id="Vector_46"
					/>
					<path
						d={svgPaths.p3df162c0}
						fill="var(--fill-0, #9BA56B)"
						id="Vector_47"
					/>
					<path
					...
					/>
					<path
						d={svgPaths.p3ae46300}
						fill="var(--fill-0, #9BA56B)"
						id="Vector_51"
					/>
					<path
						d={svgPaths.p2c8dd180}
						fill="var(--fill-0, #1E4A35)"
						id="Vector_52"
					/>
					<path
						d={svgPaths.p346f8680}
						fill="var(--fill-0, #9BA56B)"
						id="Vector_53"
					/>
					<path
						d={svgPaths.p31ae9100}
						fill="var(--fill-0, #1E4A35)"
						id="Vector_54"
					/>
					<path
						d={svgPaths.p37e28200}
						fill="var(--fill-0, #9BA56B)"
						id="Vector_55"
					/>
					<path
						d={svgPaths.p1f95f800}
						fill="var(--fill-0, #1E4A35)"
						id="Vector_56"
					/>
					<path
					...
					/>
					<path
						d={svgPaths.p3c32f900}
						fill="var(--fill-0, #1E4A35)"
						id="Vector_58"
					/>
					<path
						d={svgPaths.p28d25d80}
						fill="var(--fill-0, #9BA56B)"
						id="Vector_59"
					/>
					<path
						d={svgPaths.p3cfecd80}
						fill="var(--fill-0, #1E4A35)"
						id="Vector_60"
					/>
					<path
						d={svgPaths.p29380100}
						fill="var(--fill-0, #1E4A35)"
						id="Vector_61"
					/>
					<path
						d={svgPaths.p16ae1100}
						fill="var(--fill-0, #9BA56B)"
						id="Vector_62"
					/>
					<path
					...
					/>
					<path
						d={svgPaths.p1b60aa40}
						fill="var(--fill-0, #4C352B)"
						id="Vector_67"
					/>
					<path
						d={svgPaths.p14425c00}
						fill="var(--fill-0, #4C352B)"
						id="Vector_68"
					/>
				</g>
	...
	return (
		<div
			...
			<svg
				...
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 84.3228 64.4531">
				<g id="Group">
					<path
						d={svgPaths.p3b776300}
						fill="var(--fill-0, #B68CBB)"
						id="Vector"
					/>
					<path
						d={svgPaths.p2800f600}
						fill="var(--fill-0, #B68CBB)"
						id="Vector_2"
					/>
					<path
						d={svgPaths.p1c8a1480}
						fill="var(--fill-0, #B68CBB)"
						id="Vector_3"
					/>
					<path
						d={svgPaths.p248f7300}
						fill="var(--fill-0, #B68CBB)"
						id="Vector_4"
					/>
					<path
						d={svgPaths.p26f17500}
						fill="var(--fill-0, #B68CBB)"
						id="Vector_5"
					/>
					<path
						d={svgPaths.p2e425400}
						fill="var(--fill-0, #B68CBB)"
						id="Vector_6"
					/>
					<path
					...
					/>
					<path
						d={svgPaths.p11961490}
						fill="var(--fill-0, #B68CBB)"
						id="Vector_8"
					/>
					<path
						d={svgPaths.p3ef0df80}
						fill="var(--fill-0, #B68CBB)"
						id="Vector_9"
					/>
					<path
					...
					/>
					<path
						d={svgPaths.p2365c400}
						fill="var(--fill-0, #B68CBB)"
						id="Vector_11"
					/>
					<path
						d={svgPaths.p3d7ff000}
						fill="var(--fill-0, #EBC194)"
						id="Vector_12"
					/>
					<path
						d={svgPaths.p3eca8d80}
						fill="var(--fill-0, #F7E6D4)"
						id="Vector_13"
					/>
					<path
						d={svgPaths.p3d2bb880}
						fill="var(--fill-0, #F7E6D4)"
						id="Vector_14"
					/>
					<path
						d={svgPaths.p1dfed680}
						fill="var(--fill-0, #F7E6D4)"
						id="Vector_15"
					/>
					<path
					...
					/>
					<path
						d={svgPaths.p31464400}
						fill="var(--fill-0, #F7E6D4)"
						id="Vector_18"
					/>
					<path
						d={svgPaths.p277e0c00}
						fill="var(--fill-0, #F7E6D4)"
						id="Vector_19"
					/>
					<path
						d={svgPaths.p12d3c500}
						fill="var(--fill-0, #A35380)"
						id="Vector_20"
					/>
					<path
						d={svgPaths.p178d9900}
						fill="var(--fill-0, #D78228)"
						id="Vector_21"
					/>
					<path
						d={svgPaths.p2a06c080}
						fill="var(--fill-0, #E0AF62)"
						id="Vector_22"
					/>
					<path
						d={svgPaths.p3e488600}
						fill="var(--fill-0, #D78228)"
						id="Vector_23"
					/>
					<path
						d={svgPaths.p1e0f4600}
						fill="var(--fill-0, #E0AF62)"
						id="Vector_24"
					/>
					<path
						d={svgPaths.p1834d8c0}
						fill="var(--fill-0, #E0AF62)"
						id="Vector_25"
					/>
					<path
						d={svgPaths.p3d31f400}
						fill="var(--fill-0, #E0AF62)"
						id="Vector_26"
					/>
					<path
					...
					/>
					<path
						d={svgPaths.p20d5da00}
						fill="var(--fill-0, #E0AF62)"
						id="Vector_28"
					/>
					<path
						d={svgPaths.p298f18c0}
						fill="var(--fill-0, #E0AF62)"
						id="Vector_29"
					/>
					<path
						d={svgPaths.p3989a380}
						fill="var(--fill-0, #E0AF62)"
						id="Vector_30"
					/>
					<path
						d={svgPaths.p11a2c300}
						fill="var(--fill-0, #E0AF62)"
						id="Vector_31"
					/>
					<path
						d={svgPaths.p2a460900}
						fill="var(--fill-0, #85A687)"
						id="Vector_32"
					/>
					<path
						d={svgPaths.p12c1a400}
						fill="var(--fill-0, #C2CE86)"
						id="Vector_33"
					/>
					<path
					...
					/>
					<path
						d={svgPaths.p18385a80}
						fill="var(--fill-0, #C2CE86)"
						id="Vector_35"
					/>
					<path
						d={svgPaths.p326c3580}
						fill="var(--fill-0, #C2CE86)"
						id="Vector_36"
					/>
					<path
						d={svgPaths.p3fcb9200}
						fill="var(--fill-0, #C2CE86)"
						id="Vector_37"
					/>
					<path
						d={svgPaths.p3bf35300}
						fill="var(--fill-0, #85A687)"
						id="Vector_38"
					/>
					<path
						d={svgPaths.p2686b7f0}
						fill="var(--fill-0, #C2CE86)"
						id="Vector_39"
					/>
					<path
	...
	return (
		<div
			...
			<svg
				...
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 104.985 277.639">
				<g id="Group">
					<g id="Group_2">
						<path
							d={svgPaths.p119f95f0}
							fill="var(--fill-0, #5A381F)"
							id="Vector"
						/>
						<path
							d={svgPaths.p18f405b0}
							fill="var(--fill-0, #372816)"
							id="Vector_2"
						/>
						<path
							d={svgPaths.pbe82000}
							fill="var(--fill-0, #452B17)"
							id="Vector_3"
						/>
						<path
							d={svgPaths.p9cce800}
						...
						/>
						<path
							d={svgPaths.p39df2000}
							fill="var(--fill-0, #643D22)"
							id="Vector_5"
						/>
						<path
							d={svgPaths.p37f75880}
							fill="var(--fill-0, #9C968E)"
							id="Vector_6"
						/>
						<path
							d={svgPaths.p2943db40}
							fill="var(--fill-0, #CA8933)"
							id="Vector_7"
						/>
						<path
							d={svgPaths.pa787800}
							fill="var(--fill-0, #332515)"
							id="Vector_8"
						/>
						<path
							d={svgPaths.p26a4e000}
							fill="var(--fill-0, #CA8933)"
							id="Vector_9"
						/>
						<path
							d={svgPaths.pf428800}
							fill="var(--fill-0, #694022)"
							id="Vector_10"
						/>
						<path
							d={svgPaths.p3781fc80}
							fill="var(--fill-0, #211B12)"
							id="Vector_11"
						/>
						<path
							d={svgPaths.p28858700}
							fill="var(--fill-0, #C98832)"
							id="Vector_12"
						/>
						<path
							d={svgPaths.p34bcf790}
							fill="var(--fill-0, #14130E)"
							id="Vector_13"
						/>
						<path
							d={svgPaths.p28164f00}
							fill="var(--fill-0, #CB8B36)"
							id="Vector_14"
						/>
						<path
							d={svgPaths.p18c7f380}
							fill="var(--fill-0, #CC8B34)"
							id="Vector_15"
						/>
						<path
							d={svgPaths.p20f3a280}
							fill="var(--fill-0, #CA8A35)"
							id="Vector_16"
						/>
						<path
							d={svgPaths.p8128400}
							fill="var(--fill-0, #C68734)"
							id="Vector_17"
						/>
						<path
							d={svgPaths.p3bae2c00}
							fill="var(--fill-0, #99938A)"
							id="Vector_18"
						/>
						<path
							d={svgPaths.pac18b00}
							fill="var(--fill-0, #9F998F)"
							id="Vector_19"
						/>
						<path
							d={svgPaths.p1b9fb700}
							fill="var(--fill-0, #9A948B)"
							id="Vector_20"
						/>
						<path
							d={svgPaths.p2ce87900}
							fill="var(--fill-0, #5A381F)"
							id="Vector_21"
						/>
						<path
						...
						/>
						<path
							d={svgPaths.p273c0500}
							fill="var(--fill-0, #CC8B34)"
							id="Vector_23"
						/>
						<path
							d={svgPaths.p15d28f00}
							fill="var(--fill-0, #452B17)"
							id="Vector_24"
						/>
						<path
							d={svgPaths.p3b87a200}
							fill="var(--fill-0, #242017)"
							id="Vector_25"
						/>
						<path
							d={svgPaths.pa64b400}
							fill="var(--fill-0, #CC8A34)"
							id="Vector_26"
						/>
						<path
							d={svgPaths.p37d03b00}
							fill="var(--fill-0, #CB8933)"
							id="Vector_27"
						/>
						<path
							d={svgPaths.p1d7ace00}
							fill="var(--fill-0, #9C978E)"
							id="Vector_28"
						/>
						<path
							d={svgPaths.p1fef3c00}
							fill="var(--fill-0, #9D978C)"
							id="Vector_29"
						/>
						<path
							d={svgPaths.p922dc00}
						...
						/>
						<path
							d={svgPaths.p250c9600}
							fill="var(--fill-0, #C0BCB6)"
							id="Vector_31"
						/>
					</g>
					<path
						d={svgPaths.p1295000}
						fill="var(--fill-0, #9B8F84)"
						id="Vector_32"
					/>
				</g>
			</svg>
	...
	return (
		<div
			...
			<svg
				...
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 98.4163 232.752">
				<g id="Group">
					<path
						d={svgPaths.p1ce71000}
						fill="var(--fill-0, #35291A)"
						id="Vector"
					/>
					<path
						d={svgPaths.p5a2ddc0}
						fill="var(--fill-0, #553822)"
						id="Vector_2"
					/>
					<path
						d={svgPaths.p19b6e600}
						fill="var(--fill-0, #C48037)"
						id="Vector_3"
					/>
					<path
						d={svgPaths.pd748b00}
					...
					/>
					<path
						d={svgPaths.p335b2000}
						fill="var(--fill-0, #C48037)"
						id="Vector_7"
					/>
					<path
						d={svgPaths.p18625a80}
						fill="var(--fill-0, #C48037)"
						id="Vector_8"
					/>
					<path
						d={svgPaths.p2d597100}
						fill="var(--fill-0, #C48037)"
						id="Vector_9"
					/>
					<path
						d={svgPaths.p10c8f500}
						fill="var(--fill-0, #C48037)"
						id="Vector_10"
					/>
					<path
						d={svgPaths.p1c0ede00}
						fill="var(--fill-0, #35291A)"
						id="Vector_11"
					/>
					<path
					...
					/>
					<path
						d={svgPaths.p13ea3200}
						fill="var(--fill-0, #35291A)"
						id="Vector_13"
					/>
					<path
						d={svgPaths.p1f9ccd00}
						fill="var(--fill-0, #C48037)"
						id="Vector_14"
					/>
					<path
						d={svgPaths.p2c215780}
						fill="var(--fill-0, #35291A)"
						id="Vector_15"
					/>
					<path
						d={svgPaths.p1a8b3b00}
						fill="var(--fill-0, #35291A)"
						id="Vector_16"
					/>
					<path
						d={svgPaths.p30a10180}
						fill="var(--fill-0, #E4FFD7)"
						id="Vector_17"
					/>
					<path
						d={svgPaths.p21c81f80}
						fill="var(--fill-0, #C48037)"
						id="Vector_18"
					/>
				</g>
	...
	return (
		<div
			...
			<svg
				...
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 108.361 65.2806">
				<g id="Group">
					<path
						d={svgPaths.p18449900}
						fill="var(--fill-0, #AC6820)"
						id="Vector"
					/>
					<path
						d={svgPaths.p1dab6a00}
						fill="var(--fill-0, #122C20)"
						id="Vector_2"
					/>
					<path
					...
					/>
					<path
						d={svgPaths.p10905600}
						fill="var(--fill-0, #4C352B)"
						id="Vector_6"
					/>
					<path
						d={svgPaths.p3437f900}
						fill="var(--fill-0, #7B6A62)"
						id="Vector_7"
					/>
					<path
						d={svgPaths.p2c2d8700}
						fill="var(--fill-0, #4C352B)"
						id="Vector_8"
					/>
					<path
						d={svgPaths.p2de0a380}
						fill="var(--fill-0, #7B6A62)"
						id="Vector_9"
					/>
					<path
						d={svgPaths.p1d8f4900}
						fill="var(--fill-0, #D78228)"
						id="Vector_10"
					/>
					<path
						d={svgPaths.p2ab31480}
						fill="var(--fill-0, #E0AF62)"
						id="Vector_11"
					/>
					<path
					...
					/>
					<path
						d={svgPaths.p39709340}
						fill="var(--fill-0, #F5E091)"
						id="Vector_15"
					/>
					<path
						d={svgPaths.p187cd980}
						fill="var(--fill-0, #F5E091)"
						id="Vector_16"
					/>
					<path
					...
					/>
					<path
						d={svgPaths.p37a16a00}
						fill="var(--fill-0, #F5E091)"
						id="Vector_18"
					/>
					<path
						d={svgPaths.p2a0253f0}
						fill="var(--fill-0, #F5E091)"
						id="Vector_19"
					/>
					<path
						d={svgPaths.p182f3700}
						fill="var(--fill-0, #E0AF62)"
						id="Vector_20"
					/>
					<path
						d={svgPaths.p3fea2d80}
						fill="var(--fill-0, #F5E091)"
						id="Vector_21"
					/>
					<path
						d={svgPaths.p1a01ae80}
						fill="var(--fill-0, #F5E091)"
						id="Vector_22"
					/>
					<path
						d={svgPaths.p34950c00}
						fill="var(--fill-0, #F5E091)"
						id="Vector_23"
					/>
					<path
						d={svgPaths.p1cacc900}
						fill="var(--fill-0, #F5E091)"
						id="Vector_24"
					/>
					<path
						d={svgPaths.p33a7a400}
						fill="var(--fill-0, #F5E091)"
						id="Vector_25"
					/>
					<path
						d={svgPaths.p1bb81400}
						fill="var(--fill-0, #C2CE86)"
						id="Vector_26"
					/>
					<path
						d={svgPaths.p127f9000}
						fill="var(--fill-0, #85A687)"
						id="Vector_27"
					/>
					<path
						d={svgPaths.p35516880}
						fill="var(--fill-0, #85A687)"
						id="Vector_28"
					/>
					<path
						d={svgPaths.p2a107d80}
						fill="var(--fill-0, #85A687)"
						id="Vector_29"
					/>
					<path
						d={svgPaths.p2237d6f0}
						fill="var(--fill-0, #85A687)"
						id="Vector_30"
					/>
					<path
						d={svgPaths.p1a78baf0}
						fill="var(--fill-0, #85A687)"
						id="Vector_31"
					/>
					<path
						d={svgPaths.p36b5c500}
						fill="var(--fill-0, #85A687)"
						id="Vector_32"
					/>
					<path
						d={svgPaths.p139cb000}
						fill="var(--fill-0, #85A687)"
						id="Vector_33"
					/>
					<path
						d={svgPaths.p2faa1200}
						fill="var(--fill-0, #C2CE86)"
						id="Vector_34"
					/>
					<path
					...
					/>
					<path
						d={svgPaths.p144bd100}
						fill="var(--fill-0, #85A687)"
						id="Vector_36"
					/>
					<path
						d={svgPaths.p1a695800}
						fill="var(--fill-0, #85A687)"
						id="Vector_37"
					/>
					<path
						d={svgPaths.p17cb6d70}
						fill="var(--fill-0, #85A687)"
						id="Vector_38"
					/>
					<path
						d={svgPaths.p2f80a300}
						fill="var(--fill-0, #85A687)"
						id="Vector_39"
					/>
					<path
						d={svgPaths.p2cf0f380}
						fill="var(--fill-0, #85A687)"
						id="Vector_40"
					/>
					<path
						d={svgPaths.p17644280}
						fill="var(--fill-0, #85A687)"
						id="Vector_41"
					/>
					<path
						d={svgPaths.p286d0b80}
						fill="var(--fill-0, #85A687)"
						id="Vector_42"
					/>
					<path
					...
					/>
					<path
						d={svgPaths.p165ce300}
						fill="var(--fill-0, #AC6820)"
						id="Vector_49"
					/>
					<path
						d={svgPaths.p30088e00}
						fill="var(--fill-0, #AC6820)"
						id="Vector_50"
					/>
					<path
	...
	return (
		<div className="absolute inset-[17.88%_0_0_92.63%]" data-name="Group">
			<svg
				...
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 94.3932 266.876">
				<g id="Group">
					<path
						d={svgPaths.p1bda7f80}
						fill="var(--fill-0, #C2CE86)"
						id="Vector"
					/>
					<path
						d={svgPaths.pf779900}
						fill="var(--fill-0, #4F2C15)"
						id="Vector_2"
					/>
					<path
						d={svgPaths.pc534480}
						fill="var(--fill-0, #BC8348)"
						id="Vector_3"
					/>
					<path
						d={svgPaths.p3a15c600}
						fill="var(--fill-0, #221A0F)"
						id="Vector_4"
					/>
					<path
						d={svgPaths.p33589d00}
						fill="var(--fill-0, #D7CCC6)"
						id="Vector_5"
					/>
					<path
						d={svgPaths.p6a3c280}
						fill="var(--fill-0, #663619)"
						id="Vector_6"
					/>
					<path
						d={svgPaths.p2cd62ff2}
						fill="var(--fill-0, #542F17)"
						id="Vector_7"
					/>
					<path
						d={svgPaths.p767ba00}
						fill="var(--fill-0, #606A21)"
						id="Vector_8"
					/>
					<path
						d={svgPaths.p379cb700}
						fill="var(--fill-0, #9BA56B)"
						id="Vector_9"
					/>
					<path
						d={svgPaths.p9a0d980}
						fill="var(--fill-0, #231D13)"
						id="Vector_10"
					/>
					<path
						d={svgPaths.p1551cb00}
						fill="var(--fill-0, #241E13)"
						id="Vector_11"
					/>
					<path
						d={svgPaths.pa8ff700}
						fill="var(--fill-0, #6A3A1C)"
						id="Vector_12"
					/>
					<path
						d={svgPaths.p3b389c80}
						fill="var(--fill-0, #6C3A1B)"
						id="Vector_13"
					/>
					<path
						d={svgPaths.pdbc7800}
						fill="var(--fill-0, #6A3A1B)"
						id="Vector_14"
					/>
					<path
						d={svgPaths.p380cc800}
						fill="var(--fill-0, #211C13)"
						id="Vector_15"
					/>
					<path
						d={svgPaths.p31a2d700}
						fill="var(--fill-0, #C25B18)"
						id="Vector_16"
					/>
					<path
						d={svgPaths.p79d72c0}
						fill="var(--fill-0, #462814)"
						id="Vector_17"
					/>
					<path
						d={svgPaths.p295b3500}
						fill="var(--fill-0, #201B12)"
						id="Vector_18"
					/>
					<path
						d={svgPaths.p30520b00}
						fill="var(--fill-0, #542F17)"
						id="Vector_19"
					/>
					<path
						d={svgPaths.p24c72ec0}
						fill="var(--fill-0, #6D3A1B)"
						id="Vector_20"
					/>
					<path
						d={svgPaths.p2f61d130}
						fill="var(--fill-0, #9BA56B)"
						id="Vector_21"
					/>
					<path
						d={svgPaths.p2cbec000}
						fill="var(--fill-0, #A5713E)"
						id="Vector_22"
					/>
					<path
						d={svgPaths.p23197570}
						fill="var(--fill-0, #9C5118)"
						id="Vector_23"
					/>
					<path
						d={svgPaths.p3c7e0000}
						fill="var(--fill-0, #5E6720)"
						id="Vector_24"
					/>
					<path
						d={svgPaths.p2c7ba100}
						fill="var(--fill-0, #231D12)"
						id="Vector_25"
					/>
					<path
						d={svgPaths.p6414df0}
						fill="var(--fill-0, #A54013)"
						id="Vector_26"
					/>
					<path
						d={svgPaths.p3fa85f00}
						fill="var(--fill-0, #201B12)"
						id="Vector_27"
					/>
					<path
						d={svgPaths.p23358f80}
						fill="var(--fill-0, #58601E)"
						id="Vector_28"
					/>
					<path
						d={svgPaths.p27d90a80}
						fill="var(--fill-0, #BF5915)"
						id="Vector_29"
					/>
					<path
						d={svgPaths.p3056cdf0}
						fill="var(--fill-0, #D68C34)"
						id="Vector_30"
					/>
					<path
						d={svgPaths.p33ef8c00}
						fill="var(--fill-0, #F2F0EA)"
						id="Vector_31"
					/>
					<path
						d={svgPaths.pf585c00}
						fill="var(--fill-0, #E9E7CF)"
						id="Vector_32"
					/>
					<path
						d={svgPaths.p3de38080}
						fill="var(--fill-0, #C2BCB5)"
						id="Vector_33"
					/>
					<path
						d={svgPaths.p2c679080}
						fill="var(--fill-0, #492914)"
						id="Vector_34"
					/>
					<path
						d={svgPaths.p16afb900}
						fill="var(--fill-0, #1F1A10)"
						id="Vector_35"
					/>
					<path
						d={svgPaths.p3dc60c00}
						fill="var(--fill-0, #B86924)"
						id="Vector_36"
					/>
				</g>
			</svg>
		...
		<div
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 460.933 96.9156">
					<path
						d={svgPaths.p148be780}
						fill="var(--fill-0, #7B6A62)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 277.978 68.1563">
					<path
						d={svgPaths.p38a62600}
						fill="var(--fill-0, #7B6A62)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 456.238 93.6745">
					<path
						d={svgPaths.p78d9b80}
						fill="var(--fill-0, #7EA06E)"
						id="Vector"
					/>
				</svg>
			</div>
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 3.568 9.2994">
					<path
						d={svgPaths.p22759c30}
						fill="var(--fill-0, #9BA56B)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 434.424 37.4475">
					<path
						d={svgPaths.p1a9de000}
						fill="var(--fill-0, #1A5331)"
						id="Vector"
					/>
				</svg>
			</div>
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 16.8519 29.9281">
					<path
						d={svgPaths.p2acb9480}
						fill="var(--fill-0, #9BA56B)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 21.6606 38.4557">
					<path
						d={svgPaths.p332cd200}
						fill="var(--fill-0, #9BA56B)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 11.9755 21.2622">
					<path
						d={svgPaths.p266eee80}
						fill="var(--fill-0, #9BA56B)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 4.81953 2.4983">
					<path
						d={svgPaths.p33957f00}
						fill="var(--fill-0, #FFF5E0)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 4.81729 2.49928">
					<path
						d={svgPaths.p1055a800}
						fill="var(--fill-0, #FFF5E0)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 4.81707 2.49928">
					<path
						d={svgPaths.p17d0a900}
						fill="var(--fill-0, #FFF5E0)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 4.8193 2.4983">
					<path
						d={svgPaths.p302a8300}
						fill="var(--fill-0, #FFF5E0)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 3.07761 1.43922">
					<path
						d={svgPaths.p20de0000}
						fill="var(--fill-0, #FFF5E0)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 4.8193 2.94861">
					<path
						d={svgPaths.p3ca68cf0}
						fill="var(--fill-0, #FFF5E0)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 3.2974 2.473">
					<path
						d={svgPaths.p361ea700}
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 0.989535 1.57927">
					<path
						d={svgPaths.p17fa6800}
						fill="var(--fill-0, #DCA752)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 3.34045 2.0907">
					<path
						d={svgPaths.p3f8de580}
						fill="var(--fill-0, #DCA752)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 5.83077 11.412">
					<path
						d={svgPaths.p27acaff0}
						fill="var(--fill-0, #DCA752)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 4.01533 10.9817">
					<path
						d={svgPaths.p3746e580}
						fill="var(--fill-0, #DCA752)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 5.06419 10.7895">
					<path
						d={svgPaths.p1f592700}
						fill="var(--fill-0, #DCA752)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 7.22038 10.2981">
					<path
						d={svgPaths.p21c40b00}
						fill="var(--fill-0, #DCA752)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 8.07915 10.0231">
					<path
						d={svgPaths.p20282400}
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 16.0214 36.5196">
					<path
						d={svgPaths.p1d811b00}
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 2.18443 5.99811">
					<path
						d={svgPaths.p37a40f00}
						fill="var(--fill-0, #86A687)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 2.68428 6.9082">
					<path
						d={svgPaths.p19096280}
						fill="var(--fill-0, #86A687)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 2.49166 4.95642">
					<path
						d={svgPaths.p29b22b00}
						fill="var(--fill-0, #86A687)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 2.51444 7.34987">
					<path
						d={svgPaths.p3beaedf0}
						fill="var(--fill-0, #86A687)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 21.2142 21.9645">
					<path
						d={svgPaths.p1f338b80}
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 1.7565 2.66542">
					<path
						d={svgPaths.p3b774780}
						fill="var(--fill-0, #B68CBB)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 3.88936 3.58649">
					<path
						d={svgPaths.p35853f80}
						fill="var(--fill-0, #B68CBB)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 11.3993 14.4898">
					<path
						d={svgPaths.p3301b800}
						fill="var(--fill-0, #B68CBB)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 3.88613 1.81161">
					<path
						d={svgPaths.p258c0e00}
						fill="var(--fill-0, #B68CBB)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 1.55762 5.17279">
					<path
						d={svgPaths.p1fea0580}
						fill="var(--fill-0, #B68CBB)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 2.15328 3.21736">
					<path
						d={svgPaths.p22e8e100}
						fill="var(--fill-0, #B68CBB)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 4.0656 7.25107">
					<path
						d={svgPaths.p1a730300}
						fill="var(--fill-0, #B68CBB)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 3.88695 10.098">
					<path
						d={svgPaths.p20f45100}
						fill="var(--fill-0, #B68CBB)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 3.66066 9.82361">
					<path
						d={svgPaths.p21789100}
						fill="var(--fill-0, #B68CBB)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 2.57945 1.51458">
					<path
						d={svgPaths.p13979ac0}
						fill="var(--fill-0, #C3CE87)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 1.48386 2.17262">
					<path
						d={svgPaths.p1ac69b00}
						fill="var(--fill-0, #C3CE87)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 1.86896 3.4106">
					<path
						d={svgPaths.p32a9e980}
						fill="var(--fill-0, #C3CE87)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 4.28874 3.90301">
					<path
						d={svgPaths.p2eda4280}
						fill="var(--fill-0, #C3CE87)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 6.45072 24.1308">
					<path
						d={svgPaths.p17a53000}
						fill="var(--fill-0, #C3CE87)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 10.5228 32.7777">
					<path
						d={svgPaths.p24d7e500}
						fill="var(--fill-0, #86A687)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 4.11423 5.02313">
					<path
						d={svgPaths.p16a95780}
						fill="var(--fill-0, #86A687)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 4.42488 2.9734">
					<path
						d={svgPaths.p38d87b00}
						fill="var(--fill-0, #86A687)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 0.926653 1.56589">
					<path
						d={svgPaths.p2dcd8ea0}
						fill="var(--fill-0, #86A687)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 1.82699 3.47976">
					<path
						d={svgPaths.p208d5300}
						fill="var(--fill-0, #B68CBB)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 2.76622 1.7902">
					<path
						d={svgPaths.p185544f0}
						fill="var(--fill-0, #B68CBB)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 0.00361791 0.00321872">
					<path
						d={svgPaths.p3a277f00}
						fill="var(--fill-0, #B68CBB)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 50.8126 32.3568">
					<path
						d={svgPaths.p340e5880}
						fill="var(--fill-0, #4C352B)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 15.2583 14.4387">
					<path
						d={svgPaths.p3505d580}
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 19.9933 1.91164">
					<path
						d={svgPaths.p329aec20}
						fill="var(--fill-0, #DFAF62)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 19.9933 1.69303">
					<path
						d={svgPaths.p12b344a0}
						fill="var(--fill-0, #DFAF62)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 19.9933 1.69527">
					<path
						d={svgPaths.p14ffc230}
						fill="var(--fill-0, #DFAF62)"
						id="Vector"
					/>
				</svg>
		...
		<div
			...
			<svg
				...
				<g clipPath="url(#clip0_1_1146)" id="Capa_1">
					...
					/>
					<path
						d={svgPaths.p322fda00}
						fill="var(--fill-0, #4C352B)"
						id="Vector_2"
					/>
					<path
						d={svgPaths.p12bb9800}
						fill="var(--fill-0, #4C352B)"
						id="Vector_3"
					/>
					<path
						d={svgPaths.p3be66400}
						fill="var(--fill-0, #4C352B)"
						id="Vector_4"
					/>
					<path
						d={svgPaths.p221ebd00}
						fill="var(--fill-0, #4C352B)"
						id="Vector_5"
					/>
					<path
		...
		<div
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 125.707 122.46">
					<path
						d={svgPaths.p32d2ed80}
						fill="var(--fill-0, #F5E091)"
						id="Vector"
					/>
				</svg>
...
function ImpactStatCard({ Icon, label, value }: ImpactItem) {
	return (
		<div className="content-stretch flex flex-col gap-[56px] items-start relative w-[214px]">
			<Icon />
			<div className="content-stretch flex flex-col gap-[24px] items-start not-italic relative shrink-0 w-full">
				<p className="font-['Fraunces',serif] font-normal leading-[normal] relative shrink-0 text-[#4c352b] text-[64px] tracking-[1.92px] w-full">
					{value}
				</p>
	...
	return (
		<div
			...
			<svg
				...
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 51.6108 52.471">
				<g clipPath="url(#clip0_1_1007)" id="Capa_1">
					<path
						d={svgPaths.p2bb16000}
						fill="var(--fill-0, #4C352B)"
						id="Vector"
					/>
					<path
			...
			<svg
				...
				<g id="Group">
					...
					<g clipPath="url(#clip0_1_996)" id="Capa_1">
						...
						/>
						<path
							d={svgPaths.p37032800}
							fill="var(--fill-0, #4C352B)"
							id="Vector_4"
						/>
						<path
							d={svgPaths.p21c0f480}
							fill="var(--fill-0, #4C352B)"
							id="Vector_5"
						/>
						<path
...
function ImpactSection() {
	return (
		<div className="bg-[#f9ecbd] h-[771px] overflow-clip relative shrink-0 w-full">
			<BackgroundBottomSvg
				className="absolute inset-x-0 top-0 w-full max-w-none pointer-events-none select-none"
				fill="#FFFFFF"
			/>
			<ContentContainer size="wide" className="relative z-10">
				<div className="grid gap-12 pt-[325px] lg:grid-cols-[minmax(0,368px)_repeat(3,minmax(0,1fr))]">
					<p className="font-['Fraunces',serif] font-normal leading-[1.42] not-italic text-[#4c352b] text-[32px] tracking-[0.96px] w-full">
						By keeping food in the human food supply chain, we have
						an impact on various levels:
					</p>
					{impactItems.map((item) => (
						<ImpactStatCard key={item.value} {...item} />
					))}
				</div>
			</ContentContainer>
			<div
			...
			<span className="overflow-clip relative shrink-0 size-[24px]">
				<span className="absolute inset-[25.72%_36.66%_25.88%_35.46%]">
					<svg
						...
						<path
							d={svgPaths.p36daa800}
							fill="var(--fill-0, #916F96)"
							stroke="var(--stroke-0, #916F96)"
						/>
					</svg>
				</span>
			</span>
...
function NewsCard({ date, image, title }: NewsItem) {
	return (
		<article className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px overflow-clip relative rounded-[32px]">
			<div className="aspect-[405.3333435058594/270] relative shrink-0 w-full">
				<img
					alt={title}
			...
			<div className="content-stretch flex flex-col gap-[24px] items-start py-[32px] relative shrink-0 w-full">
				<div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full">
					...
					<h3 className="font-['Fraunces',serif] font-normal leading-[32px] not-italic relative shrink-0 text-[#0f251b] text-[24px] w-full">
						{title}
					</h3>
				</div>
				<NewsReadMoreLink />
...
function NewsSectionHeader() {
	return (
		<div className="content-stretch flex items-end justify-between relative shrink-0 w-full">
			<div className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] items-start max-w-[768px] min-w-px relative">
				...
				<h2 className="font-['Fraunces',serif] font-normal leading-[1.2] not-italic relative shrink-0 text-[48px] text-black w-full">
...
function NewsSection() {
	return (
		<div
			className="bg-[#fbfafa] h-[857px] overflow-clip py-[112px] relative shrink-0 w-full"
			data-name="News">
			<ContentContainer size="wide">
