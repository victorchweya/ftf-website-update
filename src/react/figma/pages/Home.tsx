...
import { imgGroup, imgVector2, imgGroup1, imgGroup2, imgVector3, imgGroup3, imgGroup4 } from "../imports/Home/svg-00zst";
...
function Hero() {
  return (
    <div className="bg-[#fbf3e9] h-[1162px] overflow-clip relative shrink-0 w-full" data-name="Hero">
...
function Wireframe1() {
  return (
    <div className="bg-[#fbf3e9] h-[755px] overflow-clip relative shrink-0 w-full" data-name="Wireframe - 11">
...
function Layout() {
  return (
    <div className="bg-[#dae2b6] content-stretch flex flex-col items-center overflow-clip pb-[112px] pt-[64px] px-[64px] relative shrink-0 w-full" data-name="Layout / 28 /">
      <Container />
    </div>
  );
}
...
function Wireframe() {
  return (
    <div className="bg-white h-[887px] overflow-clip relative shrink-0 w-full" data-name="Wireframe - 10">
...
function News() {
  return (
    <div className="bg-[#fbfafa] content-stretch flex flex-col gap-[80px] h-[857px] items-center overflow-clip px-[64px] py-[112px] relative shrink-0 w-full" data-name="News">
      <Container1 />
      <Group37 />
    </div>
  );
...
export default function Home() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center relative w-full min-h-screen" data-name="home">
      <Hero />
      <Wireframe1 />
      <Layout />
      <Wireframe />
