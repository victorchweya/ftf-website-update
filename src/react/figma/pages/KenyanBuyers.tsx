	...
	return (
		<div className="relative size-full">
			<svg
				...
				viewBox="0 0 620.8 649.456">
				<g id="Group 44">
					<path
						d={svgPaths.p180e0370}
						fill="var(--fill-0, #DDCA83)"
						id="Vector"
					/>
					<path
						d={svgPaths.p11305300}
						fill="var(--fill-0, #F5E091)"
						id="Vector_2"
					/>
					<path
						d={svgPaths.p34c8e870}
						fill="var(--fill-0, #F5E091)"
						id="Vector_3"
					/>
					<path
						d={svgPaths.p29516820}
						fill="var(--fill-0, #DDCA83)"
						id="Vector_4"
					/>
					<path
						d={svgPaths.p249ca200}
						fill="var(--fill-0, #F5E091)"
						id="Vector_5"
					/>
				</g>
...
function Objects() {
	return (
		<div
			className="absolute h-[14px] left-0 top-[130.5px] w-[443px]"
			data-name="objects">
			<svg
				className="absolute block inset-0 size-full"
				fill="none"
	...
	return (
		<div
			...
			<svg
				...
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 65.697 64">
				<g id="Group">
					<path
						d={svgPaths.peb4b900}
						fill="var(--fill-0, #9BA56B)"
						id="Vector"
					/>
					<g id="Vector_2">
						<path
							d={svgPaths.p2ae4e200}
	...
	return (
		<div
			...
			<svg
				...
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 33.4477 33.9703">
				<g clipPath="url(#clip0_31_1449)" id="Capa_1">
					<path
						d={svgPaths.p3b108300}
						fill="var(--fill-0, white)"
						id="Vector"
					/>
					<path
						d={svgPaths.p2631e580}
						fill="var(--fill-0, white)"
						id="Vector_2"
					/>
					<path
		...
		<div
			...
			<svg
				...
				<g clipPath="url(#clip0_31_1427)" id="Capa_1">
					...
					/>
					<path
						d={svgPaths.p223e6b80}
						fill="var(--fill-0, white)"
						id="Vector_2"
					/>
					<path
						d={svgPaths.p36da2e00}
						fill="var(--fill-0, white)"
						id="Vector_3"
					/>
				</g>
	...
	return (
		<div
			...
			<svg
				...
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 25.0857 31.3572">
				<g clipPath="url(#clip0_31_1480)" id="Capa_1">
					<path
						d={svgPaths.p2620f300}
						fill="var(--fill-0, white)"
						id="Vector"
					/>
					<path
	...
	return (
		<div
			...
			<svg
				...
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 35.0155 32.4024">
				<g clipPath="url(#clip0_31_1477)" id="Capa_1">
					<path
						d={svgPaths.p12235800}
						fill="var(--fill-0, white)"
						id="Vector"
					/>
				</g>
	...
	return (
		<div className="col-1 h-[39.336px] ml-[15.15px] mt-[11.68px] relative row-1 w-[33.972px]">
			<svg
				...
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 33.9718 39.3363">
				<g id="Group 176">
					<path
						d={svgPaths.p3dc29000}
						fill="var(--fill-0, white)"
						id="Vector"
					/>
					<path
						d={svgPaths.p374b0c00}
						fill="var(--fill-0, white)"
						id="Vector_2"
					/>
					<path
						d={svgPaths.p2e90c680}
						fill="var(--fill-0, white)"
						id="Vector_3"
					/>
					<path
						d={svgPaths.p31c5ea00}
						fill="var(--fill-0, white)"
						id="Vector_4"
					/>
					<path
						d={svgPaths.p23b86900}
						fill="var(--fill-0, white)"
						id="Vector_5"
					/>
					<path
						d={svgPaths.p2828b300}
						fill="var(--fill-0, white)"
						id="Vector_6"
					/>
				</g>
				...
				<div className="flex-none h-[100cqw] rotate-90 w-[100cqh]">
					<div className="relative size-full" data-name="Vector">
						<svg
							...
							fill="none"
							preserveAspectRatio="none"
							viewBox="0 0 231 1503">
							<path
								d={svgPaths.p4a87f00}
								fill="var(--fill-0, #F9ECBD)"
								id="Vector"
							/>
						</svg>
					</div>
	...
	return (
		<div className="h-[440.366px] relative w-[150.712px]" data-name="Group">
			<svg
				...
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 150.712 440.366">
				<g id="Group">
					<path
						d={svgPaths.p143f6a00}
					...
					/>
					<path
						d={svgPaths.p28e58800}
						fill="var(--fill-0, #EAEAEA)"
						id="Vector_4"
					/>
					<path
						d={svgPaths.p20824200}
						fill="var(--fill-0, #EAEAEA)"
						id="Vector_5"
					/>
					<path
						d={svgPaths.p3ee7c500}
						fill="var(--fill-0, #EAEAEA)"
						id="Vector_6"
					/>
				</g>
...
function Sell1() {
	return (
		<div
			className="bg-[#122c20] content-stretch flex items-start px-[16px] py-[8px] relative rounded-[40px] shrink-0"
			data-name="sell">
			<div
				aria-hidden="true"
	...
	return (
		<div
			...
			<svg
				...
				<g id="Google logo">
					<path
						d={svgPaths.p16b80780}
						fill="var(--fill-0, #EA4335)"
						id="Vector"
					/>
					<path
						d={svgPaths.p3760ab80}
					...
					/>
					<path
						d={svgPaths.p1504a100}
						fill="var(--fill-0, #34A853)"
						id="Vector_4"
					/>
					<path
						d={svgPaths.p11831e00}
						fill="var(--fill-0, #EA4335)"
						id="Vector_5"
					/>
					<path
						d={svgPaths.p26fa8680}
						fill="var(--fill-0, #4285F4)"
						id="Vector_6"
					/>
				</g>
			...
			<div className="absolute inset-[-3.77%_-10.71%_-7.55%_-10.71%]">
				<svg
					...
					<g id="Zoom control buttons">
						...
						<path
							d={svgPaths.p3c095000}
							fill="var(--fill-0, #666666)"
							id="Union"
						/>
						<path
							d="M22 43H12V41H22V43Z"
							fill="var(--fill-0, #666666)"
							id="Union_2"
						/>
						<rect
					...
					<defs>
						<filter
							...
							<feBlend
								...
								mode="normal"
								result="effect1_dropShadow_31_1026"
							/>
							<feBlend
								in="SourceGraphic"
								in2="effect1_dropShadow_31_1026"
								mode="normal"
								result="shape"
							/>
						</filter>
		...
		<div className="absolute left-[268px] size-[40.016px] top-[160px]">
			<div className="absolute inset-[0_0_-32.45%_0]">
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 40.0158 53">
					<g id="Frame 58">
						<path
							d={svgPaths.p107dbb00}
							fill="var(--fill-0, #D78228)"
							id="Vector"
						/>
						<g id="Group">
							<g id="Group_2">
								<path
									d={svgPaths.p276ee480}
									fill="var(--fill-0, white)"
									id="Vector_2"
								/>
								<path
									d={svgPaths.p27579600}
									fill="var(--fill-0, white)"
									id="Vector_3"
								/>
							</g>
							<path
								d={svgPaths.p1061c700}
								fill="var(--fill-0, white)"
								id="Vector_4"
							/>
						</g>
...
function Content1() {
	return (
		<div
			className="content-stretch flex flex-col gap-[64px] h-[462px] items-start relative shrink-0 w-full"
			data-name="Content">
			<GoogleMapsMockup />
			<Group25 />
		</div>
		...
		<div
			...
			<svg
				...
				<g id="prime:info-circle">
					<path
						d={svgPaths.p336bedf0}
						fill="var(--fill-0, #D78228)"
						id="Vector"
					/>
					<path
						d={svgPaths.p2ccca600}
						fill="var(--fill-0, #D78228)"
						id="Vector_2"
					/>
				</g>
...
function Wireframe2() {
	return (
		<div
			...
			<div
				className="absolute bottom-[814.78px] flex h-[223.22px] items-center justify-center right-[-330.48px] w-[838.475px]"
				style={
					{
						"--transform-inner-width": "1185",
						"--transform-inner-height": "21",
			...
			<div
				className="-translate-x-1/2 absolute flex h-[227.965px] items-center justify-center left-[calc(45.83%+19.92px)] top-[1426.15px] w-[486.457px]"
				style={
					{
						"--transform-inner-width": "1185",
						"--transform-inner-height": "21",
...
function Group8() {
	return (
		<div
			className="absolute h-[200px] left-[88px] top-[150px] w-[205.303px]"
			data-name="Group">
			<svg
				className="absolute block inset-0 size-full"
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 205.303 200">
				<g id="Group">
					<path
						d={svgPaths.p90d8200}
						fill="var(--fill-0, #8C98EE)"
						id="Vector"
					/>
					<g clipPath="url(#clip0_31_1164)" id="Design">
						<path
							d={svgPaths.p3a267380}
							fill="var(--fill-0, #1D180E)"
							id="Vector_2"
						/>
						<path
							d={svgPaths.p25550480}
							fill="var(--fill-0, #633418)"
							id="Vector_3"
						/>
						<path
							d={svgPaths.pe97da00}
						...
						/>
						<path
							d={svgPaths.p1b8caa00}
							fill="var(--fill-0, #F7E6D4)"
							id="Vector_5"
						/>
						<path
							d={svgPaths.pc700b00}
							fill="var(--fill-0, #643417)"
							id="Vector_6"
						/>
						<path
							d={svgPaths.p376fd380}
							fill="var(--fill-0, #2F2B22)"
							id="Vector_7"
						/>
						<path
							d={svgPaths.p3099ac40}
							fill="var(--fill-0, #24201A)"
							id="Vector_8"
						/>
						<path
							d={svgPaths.p15f4bb00}
							fill="var(--fill-0, #DD932F)"
							id="Vector_9"
						/>
						<path
							d={svgPaths.p2a86200}
							fill="var(--fill-0, #383128)"
							id="Vector_10"
						/>
						<path
							d={svgPaths.p19021500}
							fill="var(--fill-0, #613316)"
							id="Vector_11"
						/>
						<path
							d={svgPaths.pf1b1600}
							fill="var(--fill-0, #271B0F)"
							id="Vector_12"
						/>
					</g>
					<g id="Isolation_Mode" />
		...
		<div className="absolute h-[198.445px] left-[calc(25%+22px)] top-[13px] w-[203.707px]">
			<svg
				...
				<g id="Group 282">
					...
					<g id="Group 234">
						<path
							d={svgPaths.p13ba9000}
							fill="var(--fill-0, #F7E6D4)"
							id="Vector_2"
						/>
						<path
							d={svgPaths.p2f248e00}
							fill="var(--fill-0, #4C352B)"
							id="Vector_3"
						/>
						<g id="Group 236">
							<g id="Group 235">
								<path
									d={svgPaths.p2baf5600}
									fill="var(--fill-0, #BF87A6)"
									id="Vector_4"
								/>
								<path
									d={svgPaths.p21eb4500}
									fill="var(--fill-0, #BF87A6)"
									id="Vector_5"
								/>
								<path
									d={svgPaths.p3b199a00}
									fill="var(--fill-0, #BF87A6)"
									id="Vector_6"
								/>
								<path
								...
								/>
								<path
									d={svgPaths.p27bc6d00}
									fill="var(--fill-0, #BF87A6)"
									id="Vector_11"
								/>
								<path
									d={svgPaths.p2236ea00}
									fill="var(--fill-0, #BF87A6)"
									id="Vector_12"
								/>
								<path
									d={svgPaths.p2d22dc80}
									fill="var(--fill-0, #BF87A6)"
									id="Vector_13"
								/>
								<path
									d={svgPaths.p1a0e7780}
									fill="var(--fill-0, #BF87A6)"
									id="Vector_14"
								/>
								<path
									d={svgPaths.p2dc28e70}
									fill="var(--fill-0, #A35380)"
									id="Vector_15"
								/>
							</g>
							<g id="Group">
								<path
									d={svgPaths.p1ef93300}
									fill="var(--fill-0, #85A687)"
									id="Vector_16"
								/>
								<path
									d={svgPaths.pf3b4a00}
									fill="var(--fill-0, #C2CE86)"
									id="Vector_17"
								/>
								<path
									d={svgPaths.p1998480}
							...
							<g id="Group_2">
								...
								<g id="Vector_23" />
								<path
									d={svgPaths.p116b9e00}
									fill="var(--fill-0, #D78228)"
									id="Vector_24"
								/>
								<path
									d={svgPaths.p262b1970}
									fill="var(--fill-0, #E0AF62)"
									id="Vector_25"
								/>
							</g>
							<path
								d={svgPaths.p3dfc6150}
								fill="var(--fill-0, #4C352B)"
								id="Vector_26"
							/>
						</g>
						<g id="Group_3">
							<g id="Group_4">
								<path
									d={svgPaths.p152ee200}
									fill="var(--fill-0, #E0AF62)"
									id="Vector_27"
								/>
								<path
									d={svgPaths.p2220fe00}
									fill="var(--fill-0, #4C352B)"
									id="Vector_28"
								/>
								<path
									d={svgPaths.p39d72b00}
									fill="var(--fill-0, #E0AF62)"
									id="Vector_29"
								/>
								<path
								...
								/>
								<path
									d={svgPaths.p10ad6f00}
									fill="var(--fill-0, #4C352B)"
									id="Vector_31"
								/>
								<path
									d={svgPaths.p39753e00}
									fill="var(--fill-0, #E0AF62)"
									id="Vector_32"
								/>
								<path
									d={svgPaths.p395f0e80}
									fill="var(--fill-0, #4C352B)"
									id="Vector_33"
								/>
								<path
									d={svgPaths.p11828900}
									fill="var(--fill-0, #E0AF62)"
									id="Vector_34"
								/>
								<path
									d={svgPaths.p1cd54e00}
									fill="var(--fill-0, #4C352B)"
									id="Vector_35"
								/>
								<path
									d={svgPaths.p1aef2780}
									fill="var(--fill-0, #E0AF62)"
									id="Vector_36"
								/>
								<path
							...
							<path
								d={svgPaths.p1527d540}
								fill="var(--fill-0, #E0AF62)"
								id="Vector_38"
							/>
							<path
								d={svgPaths.p29623d80}
								fill="var(--fill-0, #4C352B)"
								id="Vector_39"
							/>
							<path
								d={svgPaths.p36c36c00}
								fill="var(--fill-0, #E0AF62)"
								id="Vector_40"
							/>
							<path
								d={svgPaths.p172fb300}
								fill="var(--fill-0, #4C352B)"
								id="Vector_41"
							/>
							<path
								d={svgPaths.p3fcd2b80}
								fill="var(--fill-0, #E0AF62)"
								id="Vector_42"
							/>
							<path
								d={svgPaths.p2c1170a0}
								fill="var(--fill-0, #4C352B)"
								id="Vector_43"
							/>
							<path
								d={svgPaths.p2202c400}
								fill="var(--fill-0, #4C352B)"
								id="Vector_44"
							/>
							<path
								d={svgPaths.p2eab6880}
								fill="var(--fill-0, #E0AF62)"
								id="Vector_45"
							/>
							<path
								d={svgPaths.p1cf88f00}
								fill="var(--fill-0, #4C352B)"
								id="Vector_46"
							/>
							<path
								d={svgPaths.p1b995800}
								fill="var(--fill-0, #E0AF62)"
								id="Vector_47"
							/>
							<path
...
function Group9() {
	return (
		<div
			className="absolute h-[200px] left-[calc(41.67%+63px)] top-[176px] w-[205.303px]"
			data-name="Group">
			<svg
				className="absolute block inset-0 size-full"
				fill="none"
				...
				<g id="Group">
					...
					<g clipPath="url(#clip0_31_1194)" id="Capa_1">
						<path
							d={svgPaths.p2f1d5ea0}
							fill="var(--fill-0, #EBC194)"
							id="Vector_2"
						/>
						<g id="Group_2">
							<path
								d={svgPaths.p88b2980}
								fill="var(--fill-0, #FCF6DE)"
								id="Vector_3"
							/>
							<path
								d={svgPaths.p69f2d00}
						...
						<g id="Group_3">
							<path
								d={svgPaths.p32857500}
								fill="var(--fill-0, #D78329)"
								id="Vector_5"
							/>
							<path
								d={svgPaths.p21793a00}
								fill="var(--fill-0, #DCA752)"
								id="Vector_6"
							/>
							<path
								d={svgPaths.p3709e700}
								fill="var(--fill-0, #DCA752)"
								id="Vector_7"
							/>
							<path
								d={svgPaths.p38209200}
								fill="var(--fill-0, #DCA752)"
								id="Vector_8"
							/>
							<path
								d={svgPaths.p17662f00}
								fill="var(--fill-0, #DCA752)"
								id="Vector_9"
							/>
							<path
								d={svgPaths.p2d936080}
								fill="var(--fill-0, #DCA752)"
								id="Vector_10"
							/>
							<path
						...
						<g id="Group_4">
							<g id="Vector_13" />
							<path
								d={svgPaths.p34b80200}
								fill="var(--fill-0, #C3CE87)"
								id="Vector_14"
							/>
							<path
								d={svgPaths.p102c2c00}
								fill="var(--fill-0, #86A687)"
								id="Vector_15"
							/>
							<path
								d={svgPaths.p33e5b9c0}
								fill="var(--fill-0, #86A687)"
								id="Vector_16"
							/>
							<path
								d={svgPaths.p36969400}
								fill="var(--fill-0, #86A687)"
								id="Vector_17"
							/>
							<path
								d={svgPaths.p3df95f00}
								fill="var(--fill-0, #86A687)"
								id="Vector_18"
							/>
							<path
						...
						<g id="Group_5">
							<path
								d={svgPaths.p17866500}
								fill="var(--fill-0, #9A4173)"
								id="Vector_22"
							/>
							<path
								d={svgPaths.p3faf3580}
								fill="var(--fill-0, #B68CBB)"
								id="Vector_23"
							/>
							<path
								d={svgPaths.p11966580}
								fill="var(--fill-0, #B68CBB)"
								id="Vector_24"
							/>
							<path
								d={svgPaths.p30c20f00}
								fill="var(--fill-0, #B68CBB)"
								id="Vector_25"
							/>
							<path
							...
							/>
							<path
								d={svgPaths.p36899280}
								fill="var(--fill-0, #B68CBB)"
								id="Vector_27"
							/>
							<path
								d={svgPaths.p37ea2580}
								fill="var(--fill-0, #B68CBB)"
								id="Vector_28"
							/>
							<path
								d={svgPaths.p2ed2fb00}
								fill="var(--fill-0, #B68CBB)"
								id="Vector_29"
							/>
							<path
								d={svgPaths.p3d3bd200}
								fill="var(--fill-0, #B68CBB)"
								id="Vector_30"
							/>
							<path
								d={svgPaths.p3dbc5300}
								fill="var(--fill-0, #B68CBB)"
								id="Vector_31"
							/>
							<path
						...
						<g id="Group_6">
							...
							<g id="Vector_35" />
							<path
								d={svgPaths.p2ef62580}
								fill="var(--fill-0, #C3CE87)"
								id="Vector_36"
							/>
							<path
								d={svgPaths.p36b09b80}
								fill="var(--fill-0, #C3CE87)"
								id="Vector_37"
							/>
							<path
								d={svgPaths.p22cad000}
								fill="var(--fill-0, #C3CE87)"
								id="Vector_38"
							/>
							<path
							...
							/>
							<path
								d={svgPaths.p34fb0c80}
								fill="var(--fill-0, #C3CE87)"
								id="Vector_40"
							/>
							<path
								d={svgPaths.p3f888740}
								fill="var(--fill-0, #86A687)"
								id="Vector_41"
							/>
							<path
								d={svgPaths.p1eb9b000}
								fill="var(--fill-0, #86A687)"
								id="Vector_42"
							/>
							<path
								d={svgPaths.p20589c00}
								fill="var(--fill-0, #86A687)"
								id="Vector_43"
							/>
							<path
								d={svgPaths.p2000e000}
								fill="var(--fill-0, #86A687)"
								id="Vector_44"
							/>
							<path
								d={svgPaths.p1e7e8f80}
								fill="var(--fill-0, #86A687)"
								id="Vector_45"
							/>
							<path
								d={svgPaths.p29db1d80}
								fill="var(--fill-0, #86A687)"
								id="Vector_46"
							/>
							<path
								d={svgPaths.p39aa0780}
								fill="var(--fill-0, #86A687)"
								id="Vector_47"
							/>
						</g>
						<g id="Group_7">
							...
							/>
							<path
								d={svgPaths.p25782180}
								fill="var(--fill-0, #B68CBB)"
								id="Vector_51"
							/>
							<path
								d={svgPaths.p31cde980}
								fill="var(--fill-0, #B68CBB)"
								id="Vector_52"
							/>
						</g>
						<path
							d={svgPaths.p30097800}
							fill="var(--fill-0, #4C352B)"
							id="Vector_53"
						/>
						<path
						...
						/>
						<path
							d={svgPaths.p1d340a00}
							fill="var(--fill-0, #DFAF62)"
							id="Vector_55"
						/>
						<path
							d={svgPaths.p3a6c1700}
							fill="var(--fill-0, #DFAF62)"
							id="Vector_56"
						/>
						<path
							d={svgPaths.p1a0fe300}
							fill="var(--fill-0, #DFAF62)"
							id="Vector_57"
						/>
					</g>
...
function Vector({ className }: { className?: string }) {
	return (
		<div
			className={
				className ||
				"absolute h-[80px] left-[calc(75%-23px)] top-[421px] w-[35px]"
			}
			data-name="Vector">
			<svg
				className="absolute block inset-0 size-full"
	...
	return (
		<div className="relative size-full">
			<svg
				...
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 30.9665 57.4743">
				<g id="Group 241">
					<path
						d={svgPaths.p221df680}
						fill="var(--fill-0, #A35380)"
						id="Vector"
					/>
					<path
						d={svgPaths.p37400300}
						fill="var(--fill-0, #BF87A6)"
						id="Vector_2"
					/>
				</g>
	...
	return (
		<div className="relative size-full">
			<svg
				...
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 30.3608 55.6941">
				<g id="Group 242">
					<path
						d={svgPaths.p3775dd80}
						fill="var(--fill-0, #85A687)"
						id="Vector"
					/>
					<path
					...
					/>
					<path
						d={svgPaths.p26059a00}
						fill="var(--fill-0, #C2CE86)"
						id="Vector_3"
					/>
					<path
						d={svgPaths.p353c7100}
						fill="var(--fill-0, #C2CE86)"
						id="Vector_4"
					/>
					<path
						d={svgPaths.p20b1c380}
						fill="var(--fill-0, #C2CE86)"
						id="Vector_5"
					/>
				</g>
...
function Group10() {
	return (
		<div
			className="absolute contents inset-[46.64%_20.55%_42.81%_71.57%]"
			data-name="Group">
			<div
				className="absolute inset-[50.65%_22.75%_48.74%_77.1%]"
				data-name="Vector">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 2.25711 5.41055">
					<path
						d={svgPaths.p27f35780}
						fill="var(--fill-0, #C2CE86)"
						id="Vector"
					/>
				</svg>
			...
			<div
				className="absolute inset-[51.32%_21.45%_48.1%_78.48%]"
				data-name="Vector">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 1.00277 5.14578">
					<path
						d={svgPaths.p28e5a980}
						fill="var(--fill-0, #C2CE86)"
						id="Vector"
					/>
				</svg>
			...
			<div
				className="absolute inset-[50.24%_22.53%_48.93%_77.29%]"
				data-name="Vector">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 2.53393 7.4021">
					<path
						d={svgPaths.p3959c980}
						fill="var(--fill-0, #C2CE86)"
						id="Vector"
					/>
				</svg>
			...
			<div
				className="absolute inset-[49.91%_21.17%_49.28%_78.29%]"
				data-name="Vector">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 7.81921 7.17403">
					<path
						d={svgPaths.p3069f570}
						fill="var(--fill-0, #C2CE86)"
						id="Vector"
					/>
				</svg>
			...
			<div
				className="absolute inset-[50.79%_21.24%_44.26%_77.09%]"
				data-name="Vector">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 23.9963 43.8932">
					<path
						d={svgPaths.p19198200}
						fill="var(--fill-0, #C2CE86)"
						id="Vector"
					/>
				</svg>
			...
			<div
				className="absolute inset-[49.11%_21.09%_44.05%_76.97%]"
				data-name="Vector">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 28.0248 60.6208">
					<path
						d={svgPaths.p3fe2db00}
						fill="var(--fill-0, #85A687)"
						id="Vector"
					/>
				</svg>
			...
			<div
				className="absolute inset-[50.11%_22.44%_48.73%_77.02%]"
				data-name="Vector">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 7.7323 10.2637">
					<path
						d={svgPaths.p102b0100}
						fill="var(--fill-0, #85A687)"
						id="Vector"
					/>
				</svg>
			...
			<div
				className="absolute inset-[51%_21.37%_47.85%_78.09%]"
				data-name="Vector">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 7.79557 10.1517">
					<path
						d={svgPaths.p1530f100}
						fill="var(--fill-0, #85A687)"
						id="Vector"
					/>
				</svg>
			...
			<div
				className="absolute inset-[51.98%_21.49%_47.11%_77.91%]"
				data-name="Vector">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 8.77504 8.11583">
					<path
						d={svgPaths.p33a8ea40}
						fill="var(--fill-0, #85A687)"
						id="Vector"
					/>
				</svg>
			...
			<div
				className="absolute inset-[51.01%_22.78%_48.23%_76.85%]"
				data-name="Vector">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 5.2988 6.76895">
					<path
						d={svgPaths.p2915f480}
						fill="var(--fill-0, #85A687)"
						id="Vector"
					/>
				</svg>
			...
			<div
				className="absolute inset-[51.6%_23.01%_47.67%_76.77%]"
				data-name="Vector">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 3.1208 6.44662">
					<path
						d={svgPaths.p3639a000}
						fill="var(--fill-0, #85A687)"
						id="Vector"
					/>
				</svg>
			...
			<div
				className="absolute inset-[52.08%_23.25%_47.54%_76.67%]"
				data-name="Vector">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 1.04611 3.45354">
					<path
						d={svgPaths.p28430bf0}
						fill="var(--fill-0, #85A687)"
						id="Vector"
					/>
				</svg>
			...
			<div
				className="absolute inset-[52.18%_24.51%_45.06%_74.12%]"
				data-name="Vector">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 19.7182 24.4602">
					<path
						d={svgPaths.p92ced00}
						fill="var(--fill-0, #C2CE86)"
						id="Vector"
			...
			<Vector />
			<div
				className="absolute inset-[52.57%_24.98%_45.78%_74.65%]"
				data-name="Vector">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 5.32814 14.643">
					<path
						d={svgPaths.paba4400}
						fill="var(--fill-0, #85A687)"
						id="Vector"
			...
			<div
				className="absolute inset-[52.3%_24.85%_45.4%_74.68%]"
				data-name="Vector">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 6.67292 20.3414">
					<path
						d={svgPaths.p3fcab870}
						fill="var(--fill-0, #85A687)"
						id="Vector"
					/>
				</svg>
			...
			<div
				className="absolute inset-[52.38%_24.69%_45.72%_74.85%]"
				data-name="Vector">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 6.54943 16.8533">
					<path
						d={svgPaths.p29d0f380}
						fill="var(--fill-0, #85A687)"
						id="Vector"
					/>
				</svg>
			...
			<div
				className="absolute inset-[53.15%_25.38%_45.48%_74.19%]"
				data-name="Vector">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 6.09498 12.0989">
					<path
						d={svgPaths.p36075200}
						fill="var(--fill-0, #85A687)"
						id="Vector"
					/>
				</svg>
			...
			<div
				className="absolute inset-[52.35%_25.08%_45.63%_74.49%]"
				data-name="Vector">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 6.14543 17.9469">
					<path
						d={svgPaths.p2f071880}
						fill="var(--fill-0, #85A687)"
						id="Vector"
					/>
				</svg>
			...
			<div
				className="absolute inset-[53.13%_25.11%_45.43%_74.4%]"
				data-name="Vector">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 7.03503 12.8011">
					<path
						d={svgPaths.p1753c880}
						fill="var(--fill-0, #85A687)"
						id="Vector"
					/>
				</svg>
			...
			<div
				className="absolute inset-[46.64%_23.58%_43.32%_74.36%]"
				data-name="Vector">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 29.7106 89.0438">
					<path
						d={svgPaths.p2b7a2200}
						fill="var(--fill-0, #D78228)"
						id="Vector"
					/>
				</svg>
			...
			<div
				className="absolute inset-[48.99%_24.1%_44.67%_74.75%]"
				data-name="Vector">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 16.4984 56.2206">
					<path
						d={svgPaths.p26b22f80}
						fill="var(--fill-0, #E0AF62)"
						id="Vector"
					/>
				</svg>
			...
			<div
				className="absolute inset-[54.63%_22.7%_44.61%_77.05%]"
				data-name="Vector">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 3.58049 6.81499">
					<path
						d={svgPaths.p4021c80}
						fill="var(--fill-0, #BF87A6)"
						id="Vector"
			...
			<div
				className="absolute inset-[54.69%_22.29%_44.91%_77.34%]"
				data-name="Vector">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 5.41682 3.50929">
					<path
						d={svgPaths.pa062280}
						fill="var(--fill-0, #BF87A6)"
						id="Vector"
			...
			<div
				className="absolute inset-[55.12%_22.04%_44.88%_77.96%]"
				data-name="Vector">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
			...
			<div
				className="absolute flex inset-[49.35%_21.39%_44.17%_76.46%] items-center justify-center"
				style={{ containerType: "size" }}>
			...
			<div
				className="absolute inset-[48.87%_25.17%_44.96%_72%]"
				data-name="Vector">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 40.7373 54.7496">
					<path
						d={svgPaths.p529d400}
						fill="var(--fill-0, #E0AF62)"
						id="Vector"
			...
			<div
				className="absolute inset-[49.8%_26.46%_49.72%_73.03%]"
				data-name="Vector">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 7.2689 4.31852">
					<path
						d={svgPaths.p16784ca0}
						fill="var(--fill-0, #F5E091)"
						id="Vector"
					/>
				</svg>
			...
			<div
				className="absolute inset-[50.27%_27.22%_49.4%_72.56%]"
				data-name="Vector">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 3.27891 2.89574">
					<path
						d={svgPaths.p3a02a400}
						fill="var(--fill-0, #F5E091)"
						id="Vector"
					/>
				</svg>
			...
			<div
				className="absolute inset-[50.67%_27.42%_48.91%_72.22%]"
				data-name="Vector">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 5.23877 3.76286">
					<path
						d={svgPaths.p134d0200}
						fill="var(--fill-0, #F5E091)"
						id="Vector"
					/>
				</svg>
			...
			<div
				className="absolute inset-[50.72%_25.94%_45.6%_72.69%]"
				data-name="Vector">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 19.7448 32.6219">
					<path
						d={svgPaths.p13552d32}
						fill="var(--fill-0, #F5E091)"
						id="Vector"
					/>
				</svg>
			...
			<div
				className="absolute inset-[50.02%_25.38%_46.53%_73.43%]"
				data-name="Vector">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 17.1514 30.5732">
					<path
						d={svgPaths.p39f12f00}
						fill="var(--fill-0, #F5E091)"
						id="Vector"
					/>
				</svg>
			...
			<div
				className="absolute flex inset-[48.03%_22.36%_45.13%_74.79%] items-center justify-center"
				style={{ containerType: "size" }}>
			...
			<div
				className="absolute inset-[51.97%_24.66%_46.44%_74.86%]"
				data-name="Vector">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 6.97858 14.102">
					<path
						d={svgPaths.p1d2b9500}
						fill="var(--fill-0, #C2CE86)"
						id="Vector"
					/>
				</svg>
			...
			<div
				className="absolute inset-[51.42%_21.04%_43.71%_72%]"
				data-name="Vector">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 100.296 43.1833">
					<path
						d={svgPaths.p174bf00}
						fill="var(--fill-0, #4C352B)"
						id="Vector"
			...
			<div
				className="absolute flex inset-[54.18%_20.55%_42.81%_71.57%] items-center justify-center"
				style={{ containerType: "size" }}>
				<div className="-scale-x-100 flex-none h-[hypot(0.759955cqw,83.7893cqh)] rotate-[-2.2deg] w-[hypot(-99.24cqw,16.2107cqh)]">
					<div className="relative size-full" data-name="Vector">
						<svg
							...
							fill="none"
							preserveAspectRatio="none"
							viewBox="0 0 112.601 22.402">
							<path
								d={svgPaths.p27a19800}
								fill="var(--fill-0, #814E18)"
								id="Vector"
							/>
						</svg>
					</div>
...
function Group36() {
	return (
		<div className="absolute contents left-[calc(66.67%+51px)] top-[43px]">
			<div
				className="absolute h-[198.445px] left-[calc(66.67%+51px)] top-[43px] w-[203.707px]"
				data-name="Vector">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
			...
			<div
				className="absolute inset-[41.83%_23.33%_53.89%_74.79%]"
				data-name="Vector">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 27.0003 37.9828">
					<path
						d={svgPaths.p28eb3f80}
						fill="var(--fill-0, #AC6820)"
						id="Vector"
					/>
				</svg>
			</div>
...
function Frame4() {
	return (
		<div className="relative shrink-0 size-[40px]">
			...
			<p className="-translate-x-1/2 absolute font-['Rubik',sans-serif] font-semibold leading-[normal] left-1/2 not-italic text-[#e6e6e6] text-[16px] text-center top-[calc(50%-6px)] tracking-[0.48px] whitespace-nowrap">
				1
			</p>
		</div>
	);
...
function Frame67() {
	return (
		<div className="absolute content-stretch flex gap-[16px] items-start left-[88px] top-[377px]">
			<Frame4 />
			<Frame56 />
		</div>
	);
...
function Frame57() {
	return (
		<div className="relative shrink-0 size-[40px]">
			...
			<p className="-translate-x-1/2 absolute font-['Rubik',sans-serif] font-medium leading-[normal] left-[calc(50%+0.5px)] not-italic text-[#e6e6e6] text-[16px] text-center top-[calc(50%-6px)] tracking-[0.48px] whitespace-nowrap">
				3
			</p>
		</div>
	);
...
function Frame58() {
	return (
		<div className="content-stretch flex flex-col gap-[16px] items-start not-italic relative shrink-0 w-[204px]">
			...
			<p className="font-['Rubik',sans-serif] font-normal leading-[1.68] relative shrink-0 text-[#1e4a35] text-[14px] tracking-[0.42px] w-full">
				Select your delivery window and checkout your cart
			</p>
		</div>
	);
}
...
function Frame68() {
	return (
		<div className="absolute content-stretch flex gap-[16px] items-start left-[calc(50%-14px)] top-[399px]">
			<Frame57 />
			<Frame58 />
		</div>
	);
...
function Frame70() {
	return (
		<div className="relative shrink-0 size-[40px]">
			...
			<p className="-translate-x-1/2 absolute font-['Rubik',sans-serif] font-medium leading-[normal] left-[calc(50%+0.5px)] not-italic text-[#2b1a08] text-[16px] text-center top-[calc(50%-6px)] tracking-[0.48px] whitespace-nowrap">
				4
			</p>
		</div>
	);
...
function Frame71() {
	return (
		<div className="content-stretch flex flex-col gap-[16px] items-start not-italic relative shrink-0 w-[204px]">
			...
			<p className="font-['Rubik',sans-serif] font-normal leading-[1.68] relative shrink-0 text-[#1e4a35] text-[14px] tracking-[0.42px] w-full">
				Receive fresh, high quality ingredients directly to your
				doorstep
			</p>
		</div>
	);
...
function Frame69() {
	return (
		<div className="absolute content-stretch flex gap-[16px] items-start right-0 top-[259px]">
			<Frame70 />
			<Frame71 />
		</div>
	);
...
function Frame73() {
	return (
		<div className="relative shrink-0 size-[40px]">
			...
			<p className="-translate-x-1/2 absolute font-['Rubik',sans-serif] font-medium leading-[normal] left-1/2 not-italic text-[#e6e6e6] text-[16px] text-center top-[calc(50%-6px)] tracking-[0.48px] whitespace-nowrap">
				2
			</p>
		</div>
	);
...
function Frame74() {
	return (
		<div className="content-stretch flex flex-col gap-[16px] items-start not-italic relative shrink-0 w-[204px]">
			...
			<p className="font-['Rubik',sans-serif] font-normal leading-[1.68] relative shrink-0 text-[#1e4a35] text-[14px] tracking-[0.42px] w-full">
				Explore our wide range of fresh and dry products online
			</p>
		</div>
	);
}
...
function Frame72() {
	return (
		<div className="absolute content-stretch flex gap-[16px] items-start left-[calc(33.33%-40px)] top-0">
			<Frame73 />
			<Frame74 />
		</div>
	);
		...
		<div
			...
			<ContentContainer size="wide" className="relative z-10">
				...
				<div className="relative h-[520px] mt-[56px]">
					...
					<div
						className="absolute flex h-[138.813px] items-center justify-center left-[461px] top-[215.55px] w-[110.247px]"
						style={
							{
								"--transform-inner-width": "1185",
								"--transform-inner-height": "21",
					...
					<div
						className="absolute flex h-[94.387px] items-center justify-center left-[824px] top-[229px] w-[129.822px]"
						style={
							{
								"--transform-inner-width": "1185",
								"--transform-inner-height": "21",
...
function Order4() {
	return (
		<div
			className="content-stretch flex items-start p-[12px] relative rounded-[40px] shrink-0"
			data-name="order">
			<div
				aria-hidden="true"
				className="absolute border border-[#dae2b6] border-solid inset-0 pointer-events-none rounded-[40px]"
			/>
			<div
				className="overflow-clip relative shrink-0 size-[24px]"
...
function Frame82() {
	return (
		<div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full">
			<div
				className="h-[24.704px] relative shrink-0 w-[37.577px]"
				data-name="“">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 37.5771 24.704">
					<path
						d={svgPaths.pd9b5300}
...
function Frame5() {
	return (
		<div className="content-stretch flex flex-col items-start leading-[1.68] not-italic relative shrink-0 text-[#808080] text-[16px] tracking-[0.48px] w-full">
			<p className="font-['Rubik',sans-serif] font-semibold relative shrink-0 w-full">
				Delia Sterling
			</p>
			<p className="font-['Rubik',sans-serif] font-normal relative shrink-0 w-full">
...
function Capa4() {
	return (
		<div
			className="absolute h-[146px] left-[741px] top-[175px] w-[209px]"
			data-name="Capa_1">
			<svg
				className="absolute block inset-0 size-full"
				fill="none"
				...
				<g clipPath="url(#clip0_31_1113)" id="Capa_1">
					<g id="Group">
						<path
							d={svgPaths.p27a02840}
							fill="var(--fill-0, #D78228)"
							id="Vector"
						/>
						<path
							d={svgPaths.p25c3a352}
							fill="var(--fill-0, #E0AF62)"
							id="Vector_2"
						/>
					</g>
					<path
						d={svgPaths.p2957ff00}
						fill="var(--fill-0, #D78228)"
						id="Vector_3"
					/>
					<path
						d={svgPaths.p2b3fe670}
						fill="var(--fill-0, #D78228)"
						id="Vector_4"
					/>
					<path
					...
					<g id="Group_2">
						<path
							d={svgPaths.p3bedf400}
							fill="var(--fill-0, #D78228)"
							id="Vector_6"
						/>
						<path
							d={svgPaths.p29c91b72}
							fill="var(--fill-0, #E0AF62)"
							id="Vector_7"
						/>
					</g>
					<g id="Group_3">
						<path
							d={svgPaths.p23542000}
							fill="var(--fill-0, #D78228)"
							id="Vector_8"
						/>
						<path
							d={svgPaths.p20591780}
							fill="var(--fill-0, #E0AF62)"
							id="Vector_9"
						/>
					</g>
	...
	return (
		<div className="relative size-full" data-name="Group">
			<svg
				...
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 180.144 33.0054">
				<g id="Group">
					<path
						d={svgPaths.p1846c0b0}
						fill="var(--fill-0, #C3CE87)"
						id="Vector"
					/>
					<path
						d={svgPaths.p3263cd00}
						fill="var(--fill-0, #86A687)"
						id="Vector_2"
					/>
				</g>
	...
	return (
		<div className="relative size-full" data-name="Group">
			<svg
				...
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 177.772 53.425">
				<g id="Group">
					<path
						d={svgPaths.p11818b00}
						fill="var(--fill-0, #C3CE87)"
						id="Vector"
					/>
					<path
						d={svgPaths.p15924200}
						fill="var(--fill-0, #86A687)"
						id="Vector_2"
					/>
				</g>
	...
	return (
		<div className="absolute inset-[93.81%_38.47%_3.59%_58.91%]">
			<svg
				...
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 16.7264 8.38474">
				<g id="Group 190">
					<path
						d={svgPaths.p265279c0}
						fill="var(--fill-0, #FFF5E0)"
						id="Vector"
					/>
					<path
						d={svgPaths.pd2de700}
		...
		<div className="absolute inset-[81.18%_26.19%_15.03%_63.21%]">
			<svg
				...
				<g id="Group 191">
					...
					/>
					<path
						d={svgPaths.p2b7f1700}
						fill="var(--fill-0, #FFF5E0)"
						id="Vector_2"
					/>
					<path
						d={svgPaths.p2a133200}
						fill="var(--fill-0, #FFF5E0)"
						id="Vector_3"
					/>
					<path
						d={svgPaths.p2b289300}
						fill="var(--fill-0, #FFF5E0)"
						id="Vector_4"
					/>
				</g>
	...
	return (
		<div className="relative size-full" data-name="Group">
			<svg
				...
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 172.587 38.9457">
				<g id="Group">
					<path
						d={svgPaths.p37869270}
						fill="var(--fill-0, #C3CE87)"
						id="Vector"
					/>
					<path
						d={svgPaths.p2f237e00}
						fill="var(--fill-0, #86A687)"
						id="Vector_2"
					/>
				</g>
	...
	return (
		<div className="relative size-full">
			<svg
				...
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 59.8597 12.5832">
				<g id="Group 187">
					<path
						d={svgPaths.p33cd9e00}
						fill="var(--fill-0, #FFF5E0)"
						id="Vector"
					/>
					<path
...
function Group28() {
	return (
		<div
			className="absolute contents inset-[69.35%_35.99%_-6.27%_35.47%]"
			style={{ containerType: "size" }}>
			<div
				className="absolute flex inset-[69.78%_36.96%_-5.84%_36.43%] items-center justify-center"
				style={{ containerType: "size" }}>
			...
			<div
				className="absolute flex inset-[82.43%_47.86%_5.31%_42.98%] items-center justify-center"
				style={{ containerType: "size" }}>
	...
	return (
		<div className="relative size-full">
			<svg
				...
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 184.433 82.3061">
				<g id="Group 189">
					<g id="Group">
						<path
							d={svgPaths.p2566c640}
							fill="var(--fill-0, #C3CE87)"
							id="Vector"
						/>
						<path
							d={svgPaths.p3f6dac00}
							fill="var(--fill-0, #86A687)"
							id="Vector_2"
						/>
					</g>
					<path
						d={svgPaths.p1cc83460}
						fill="var(--fill-0, #FFF5E0)"
						id="Vector_3"
					/>
					<path
					...
					/>
					<path
						d={svgPaths.p22373500}
						fill="var(--fill-0, #FFF5E0)"
						id="Vector_5"
					/>
					<path
						d={svgPaths.p3df47700}
						fill="var(--fill-0, #FFF5E0)"
						id="Vector_6"
					/>
					<path
...
function Group32() {
	return (
		<div className="absolute contents inset-[69.35%_18.11%_-21.59%_35.47%]">
			<div
				className="absolute flex inset-[86.12%_18.11%_-1.36%_53.39%] items-center justify-center"
				style={{ containerType: "size" }}>
			...
			<div
				className="absolute flex inset-[74.04%_18.81%_4.49%_52.77%] items-center justify-center"
				style={{ containerType: "size" }}>
			...
			<Group28 />
			<div
				className="absolute flex inset-[77.09%_21.29%_-21.59%_47.19%] items-center justify-center"
				style={{ containerType: "size" }}>
					...
					<div className="relative size-full" data-name="Vector">
						<div className="absolute inset-[0_-3.13%_-12.38%_-3.13%]">
							<svg
								...
								viewBox="0 0 680 363">
								<g
									filter="url(#filter0_dd_31_1140)"
									id="Vector">
									<path
										d={svgPaths.p3dee9d80}
										fill="var(--fill-0, white)"
									/>
									<path
										d={svgPaths.p2f3f4240}
										stroke="var(--stroke-0, #E6E6E6)"
									/>
								</g>
								<defs>
									<filter
										...
										<feMorphology
											...
											operator="erode"
											radius="4"
											result="effect1_dropShadow_31_1140"
										/>
										<feOffset dy="8" />
										...
										<feMorphology
											...
											operator="erode"
											radius="4"
											result="effect2_dropShadow_31_1140"
										/>
										<feOffset dy="20" />
										...
										/>
										<feBlend
											in2="effect1_dropShadow_31_1140"
											mode="normal"
											result="effect2_dropShadow_31_1140"
										/>
										<feBlend
											in="SourceGraphic"
											in2="effect2_dropShadow_31_1140"
											mode="normal"
											result="shape"
										/>
									</filter>
...
function Order5() {
	return (
		<div
			...
			<div
				aria-hidden="true"
				className="absolute border border-[#747c50] border-solid inset-0 pointer-events-none rounded-[40px]"
			/>
			<div
				className="overflow-clip relative shrink-0 size-[24px]"
	...
	return (
		<div
			...
			<svg
				...
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 44.4335 65.2025">
				<g id="Group">
					<path
						d={svgPaths.p4e2a440}
						fill="var(--fill-0, #DABACC)"
						id="Vector"
					/>
				</g>
			</svg>
		...
		<div
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 99.2603 72.0039">
					<path
						d={svgPaths.p3915ef00}
						fill="var(--fill-0, #A35380)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<div className="absolute inset-[-0.99%_-1.71%]">
					<svg
						...
						fill="none"
						preserveAspectRatio="none"
						viewBox="0 0 30.2563 51.5082">
						<path
							d={svgPaths.p1cbeba00}
							id="Vector"
							stroke="var(--stroke-0, #A35380)"
							strokeMiterlimit="10"
						/>
					</svg>
				</div>
			...
			<div
				...
				<div className="absolute inset-[-1.31%_-3.11%]">
					<svg
						...
						fill="none"
						preserveAspectRatio="none"
						viewBox="0 0 17.0825 39.1186">
						<path
							d={svgPaths.p17f94160}
							id="Vector"
							stroke="var(--stroke-0, #A35380)"
							strokeMiterlimit="10"
						/>
	...
	return (
		<div
			...
			<svg
				...
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 55.4027 91.2125">
				<g id="Group">
					<path
						d={svgPaths.p1969e980}
						fill="var(--fill-0, #A35380)"
						id="Vector"
					/>
					<path
		...
		<div
			...
			<svg
				...
				<g id="Group">
					...
					/>
					<path
						d={svgPaths.p1ae7e700}
						id="Vector_3"
						stroke="var(--stroke-0, #A35380)"
						strokeMiterlimit="10"
					/>
					<path
						d={svgPaths.p1cbe0700}
						id="Vector_4"
						stroke="var(--stroke-0, #A35380)"
						strokeMiterlimit="10"
					/>
		...
		<div
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 90.358 24.4059">
					<path
						d={svgPaths.p32028600}
						fill="var(--fill-0, #814E18)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 90.9572 41.7605">
					<path
						d={svgPaths.p1fb21d80}
						fill="var(--fill-0, #814E18)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 71.8692 43.878">
					<path
						d={svgPaths.p313ebf70}
						fill="var(--fill-0, #C2CE86)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 64.1842 24.215">
					<path
						d={svgPaths.p22496a00}
						fill="var(--fill-0, #A35380)"
						id="Vector"
					/>
				</svg>
			...
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 86.1189 87.4181">
					<path
						d={svgPaths.p1ac43670}
						fill="var(--fill-0, #A35380)"
						id="Vector"
					/>
				</svg>
	...
	return (
		<div
			...
			<svg
				...
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 82.3012 66.7763">
				<g id="Group">
					<path
						d={svgPaths.p3b1be280}
						fill="var(--fill-0, #D78228)"
						id="Vector"
					/>
					<path
						d={svgPaths.p28987900}
						fill="var(--fill-0, #C2CE86)"
						id="Vector_2"
					/>
					<path
						d={svgPaths.p18bd3600}
						fill="var(--fill-0, #E0AF62)"
						id="Vector_3"
					/>
					<path
						d={svgPaths.p208d2c00}
						fill="var(--fill-0, #E0AF62)"
						id="Vector_4"
					/>
				</g>
	...
	return (
		<div
			...
			<svg
				...
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 62.7502 72.7133">
				<g id="Group">
					<path
						d={svgPaths.p21400400}
						fill="var(--fill-0, #D78228)"
						id="Vector"
					/>
					<path
		...
		<div
			...
			<svg
				...
				<g id="Group">
					...
					/>
					<path
						d={svgPaths.p2bf51380}
						fill="var(--fill-0, #C2CE86)"
						id="Vector_2"
					/>
					<path
						d={svgPaths.p1ed7f180}
						fill="var(--fill-0, #E0AF62)"
						id="Vector_3"
					/>
					<path
						d={svgPaths.p33198af0}
						fill="var(--fill-0, #E0AF62)"
						id="Vector_4"
					/>
				</g>
		...
		<div
			...
			<svg
				...
				<g id="Group">
					...
					/>
					<path
						d={svgPaths.p28ee4600}
						fill="var(--fill-0, #C2CE86)"
						id="Vector_2"
					/>
					<path
						d={svgPaths.p20138d00}
						fill="var(--fill-0, #E0AF62)"
						id="Vector_3"
					/>
				</g>
	...
	return (
		<div
			...
			<svg
				...
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 58.592 63.3298">
				<g id="Group">
					<path
						d={svgPaths.p134dc480}
						fill="var(--fill-0, #C2CE86)"
						id="Vector"
					/>
					<path
						d={svgPaths.p14abd6f0}
						fill="var(--fill-0, #E0AF62)"
						id="Vector_2"
					/>
				</g>
...
function Testimonial() {
	return (
		<div
			...
			<div
				className="absolute flex h-[858px] items-center justify-center left-[-2.92%] right-[-1.39%] top-[-767px]"
				style={{ containerType: "size" }}>
			...
			<div
				className="absolute flex h-[203.64px] items-center justify-center left-[128px] top-[561px] w-[245.05px]"
				style={
					{
						"--transform-inner-width": "1185",
...
function Icon() {
	return (
		<div
			className="absolute h-[56.919px] left-0 top-0 w-[16.705px]"
			data-name="icon">
			<svg
				className="absolute block inset-0 size-full"
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 16.7045 56.919">
				<g id="icon">
					<path
						d={svgPaths.p327cfc80}
						fill="var(--fill-0, white)"
						id="Vector"
					/>
					<path
						d={svgPaths.p37a93280}
						fill="var(--fill-0, white)"
						id="Vector_2"
					/>
					<path
						d={svgPaths.p39e4ca80}
						fill="var(--fill-0, white)"
						id="Vector_3"
					/>
				</g>
...
function Farm() {
	return (
		<div
			className="absolute h-[23.963px] left-[20.94px] top-[4.33px] w-[71.124px]"
			data-name="farm">
			<svg
				className="absolute block inset-0 size-full"
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 71.1241 23.9628">
				<g id="farm">
					<path
						d={svgPaths.p14292330}
						fill="var(--fill-0, white)"
						id="Vector"
					/>
					<path
						d={svgPaths.p14096500}
						fill="var(--fill-0, white)"
						id="Vector_2"
					/>
					<path
						d={svgPaths.p2cdc8200}
						fill="var(--fill-0, white)"
						id="Vector_3"
					/>
					<path
						d={svgPaths.p28d95800}
						fill="var(--fill-0, white)"
						id="Vector_4"
					/>
				</g>
...
function Feed() {
	return (
		<div
			className="absolute h-[24.417px] left-[46.17px] top-[32.5px] w-[64.778px]"
			data-name="feed">
			<svg
				className="absolute block inset-0 size-full"
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 64.778 24.4172">
				<g id="feed">
					<path
						d={svgPaths.p15a67c90}
						fill="var(--fill-0, white)"
						id="Vector"
					/>
					<path
						d={svgPaths.p1cff6200}
						fill="var(--fill-0, white)"
						id="Vector_2"
					/>
					<path
						d={svgPaths.p33c73580}
						fill="var(--fill-0, white)"
						id="Vector_3"
					/>
					<path
						d={svgPaths.p329c2300}
						fill="var(--fill-0, white)"
						id="Vector_4"
					/>
				</g>
...
function ToUnderline() {
	return (
		<div
			className="absolute h-[24.364px] left-[21.08px] top-[32.55px] w-[20.999px]"
			data-name="to + underline">
			<svg
				className="absolute block inset-0 size-full"
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 20.9995 24.3642">
				<g id="Group 123">
					<path
						d={svgPaths.p3bdeac80}
						fill="var(--fill-0, white)"
						id="Vector"
					/>
					<path
						d={svgPaths.p15288800}
						fill="var(--fill-0, white)"
						id="Vector_2"
					/>
					<path
