		...
		<div className="content-stretch flex flex-col gap-[32px] md:gap-[64px] items-center relative shrink-0 px-4">
			...
			<div className="font-['Rubik',sans-serif] font-normal leading-[1.68] not-italic relative shrink-0 text-[#1e4a35] text-[14px] md:text-[16px] text-center tracking-[0.48px] w-full max-w-[656px]">
				...
				<p className="leading-[1.68]">
					{` `}
					<br aria-hidden="true" />
					Throughout Kenya, we are the buyer of choice for farmers
					like you.
				</p>
			</div>
		</div>
	...
	return (
		<div
			...
			<svg
				...
				<g
					clipPath="url(#clip0_28_4636)"
					id="GetItOnGooglePlay_Badge_Web_color_English 1">
					<path
						d={svgPaths.p1a181380}
						fill="var(--fill-0, black)"
						id="Vector"
					/>
					<path
						d={svgPaths.p265c7f00}
						fill="var(--fill-0, #A6A6A6)"
						id="Vector_2"
					/>
					<g id="Group">
						<path
							d={svgPaths.p335e8800}
					...
					<path
						d={svgPaths.p1d998d00}
						fill="var(--fill-0, white)"
						id="Vector_10"
					/>
					<g id="Group_2">
						<path
							d={svgPaths.p3c87f600}
							fill="var(--fill-0, #EA4335)"
							id="Vector_11"
						/>
						<path
							d={svgPaths.p2fd4b080}
...
function Wireframe3() {
	return (
		<div
			...
			<ContentContainer size="wide" className="pt-[260px]">
				<Frame25 />
			</ContentContainer>
			<div
...
function Frame39() {
	return (
		<div className="content-stretch flex flex-col gap-[32px] items-center max-w-[1052px] not-italic relative shrink-0 text-center w-full">
			<p className="font-['Fraunces',serif] font-normal leading-[normal] relative shrink-0 text-[#0f251b] text-[56px] tracking-[1.68px] w-full">
				Our Offering
			</p>
...
function Layer() {
	return (
		<div
			className="col-1 h-[27px] ml-[20px] mt-[19px] relative row-1 w-[25px]"
			data-name="Layer_1">
			<svg
				className="absolute block inset-0 size-full"
				fill="none"
		...
		<div className="bg-[#fbfafa] flex-[1_0_0] min-w-px relative rounded-[30px]">
			<div className="content-stretch flex flex-col gap-[27px] items-start p-[48px] relative size-full">
				...
				<p className="font-['Rubik',sans-serif] font-normal leading-[1.68] min-w-full not-italic relative shrink-0 text-[#1e4a35] text-[16px] tracking-[0.48px] w-[min-content]">
					Since 2020, we have been giving farmers consistent market
					access for all fresh value chains.
				</p>
			</div>
		</div>
	);
...
function Capa() {
	return (
		<div
			className="col-1 h-[32px] ml-[14.9px] mt-[16.77px] relative row-1 w-[34px]"
			data-name="Capa_1">
			<svg
				className="absolute block inset-0 size-full"
				fill="none"
				...
				<g clipPath="url(#clip0_28_4874)" id="Capa_1">
					<path
						d={svgPaths.p2a071a00}
						fill="var(--fill-0, #D78228)"
						id="Vector"
					/>
					<path
						d={svgPaths.p2bfefe00}
						fill="var(--fill-0, #D78228)"
						id="Vector_2"
					/>
					<path
						d={svgPaths.p1cbae880}
						fill="var(--fill-0, #D78228)"
						id="Vector_3"
					/>
				</g>
...
function Capa1() {
	return (
		<div
			className="col-1 h-[32.925px] ml-[15.33px] mt-[14px] relative row-1 w-[33.97px]"
			data-name="Capa_1">
			<svg
				className="absolute block inset-0 size-full"
				fill="none"
	...
	return (
		<div className="bg-[#fbfafa] flex-[1_0_0] min-w-px relative rounded-[30px]">
			<div className="content-stretch flex flex-col gap-[27px] items-start p-[48px] relative size-full">
				<Frame31 />
				<p className="font-['Rubik',sans-serif] font-normal leading-[1.68] min-w-full not-italic relative shrink-0 text-[#1e4a35] text-[16px] tracking-[0.48px] w-[min-content]">
					Whether grade 1, 2 or imperfect, we buy all your product
					grades, as long as they are fresh.
				</p>
			</div>
		</div>
	);
...
function Layer1() {
	return (
		<div
			className="col-1 h-[25px] ml-[14px] mt-[19px] relative row-1 w-[38px]"
			data-name="Layer_1">
			<svg
				className="absolute block inset-0 size-full"
				fill="none"
				...
				<g clipPath="url(#clip0_28_4848)" id="Layer_1">
					<path
						d={svgPaths.pd6ef8f1}
						fill="var(--fill-0, #747C50)"
						id="Vector"
					/>
					<path
						d={svgPaths.p27a8fc00}
						fill="var(--fill-0, #747C50)"
						id="Vector_2"
					/>
					<path
						d={svgPaths.p29a70f00}
						fill="var(--fill-0, #747C50)"
						id="Vector_3"
					/>
				</g>
	...
	return (
		<div className="bg-[#fbfafa] flex-[1_0_0] min-w-px relative rounded-[30px]">
			<div className="content-stretch flex flex-col gap-[27px] items-start p-[48px] relative size-full">
				<Frame35 />
				<p className="font-['Rubik',sans-serif] font-normal leading-[1.68] min-w-full not-italic relative shrink-0 text-[#1e4a35] text-[16px] tracking-[0.48px] w-[min-content]">
					We work with our FTF aggregators, making us the most
					reliable partner, also for small quantities.
				</p>
			</div>
		</div>
	);
...
function IsolationMode() {
	return (
		<div
			className="col-1 h-[27px] ml-[16px] mt-[18px] relative row-1 w-[32px]"
...
function Wireframe4() {
	return (
		<div
			...
			<ContentContainer size="wide" className="pt-[234px]">
				<Frame38 />
			</ContentContainer>
			<Order1 />
		</div>
...
function Frame44() {
	return (
		<div className="-translate-x-1/2 absolute content-stretch flex flex-col items-center left-1/2 max-w-[1052px] top-[75px] w-full">
			<p className="font-['Fraunces',serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#0f251b] text-[56px] text-center tracking-[1.68px] w-full">
				How Does it Work
			</p>
		</div>
	);
...
function Group28() {
	return (
		<div className="absolute h-[198.445px] left-[calc(16.67%+93px)] top-[218px] w-[203.707px]">
			<svg
				className="absolute block inset-0 size-full"
				fill="none"
				preserveAspectRatio="none"
...
function Group35() {
	return (
		<div className="absolute h-[198.445px] left-[calc(41.67%+54px)] top-[365.92px] w-[203.707px]">
			<svg
				className="absolute block inset-0 size-full"
				fill="none"
				preserveAspectRatio="none"
				...
				<g id="Group 296">
					...
					<g clipPath="url(#clip0_28_4597)" id="Capa_1">
						<path
							d={svgPaths.p220fd600}
							fill="var(--fill-0, #4C352B)"
							id="Vector_2"
						/>
						<g clipPath="url(#clip1_28_4597)" id="Capa_1_2">
							<path
								d={svgPaths.p3848a170}
								fill="var(--fill-0, #F2D4B0)"
								id="Vector_3"
							/>
							<path
								d={svgPaths.p1ba85400}
								fill="var(--fill-0, #DFAF62)"
								id="Vector_4"
							/>
							<path
								d={svgPaths.p3bd71100}
								fill="var(--fill-0, #4C352B)"
								id="Vector_5"
							/>
							<path
								d={svgPaths.p35306f00}
								fill="var(--fill-0, #4C352B)"
								id="Vector_6"
							/>
							<path
						...
						<g id="Group 298">
							...
							/>
							<path
								d={svgPaths.p2d959e00}
								fill="var(--fill-0, #4C352B)"
								id="Vector_11"
							/>
							<path
								d={svgPaths.p2dd9ef00}
								fill="var(--fill-0, #4C352B)"
								id="Vector_12"
							/>
							<path
								d={svgPaths.p28f55580}
								fill="var(--fill-0, #F5DF91)"
								id="Vector_13"
							/>
							<path
								d={svgPaths.p3b4c5200}
								fill="var(--fill-0, #F5DF91)"
								id="Vector_14"
							/>
							<path
				...
				<defs>
					<clipPath id="clip0_28_4597">
						<rect
							fill="white"
							height="127"
							transform="translate(23 24.0811)"
							width="155"
						/>
					</clipPath>
					<clipPath id="clip1_28_4597">
						<rect
							fill="white"
							height="116"
							transform="translate(40.0122 38.1621)"
							width="125.701"
						/>
					</clipPath>
					<clipPath id="clip2_28_4597">
						<rect
							fill="white"
							height="18.79"
							transform="translate(87.2683 55.1621)"
							width="25.1119"
						/>
					</clipPath>
				</defs>
...
function Group29() {
	return (
		<div className="absolute contents left-[calc(66.67%+15px)] top-[248px]">
			<div
...
function Group27() {
	return (
		<div className="absolute h-[198.445px] left-[52px] top-[355px] w-[203.707px]">
			<svg
				className="absolute block inset-0 size-full"
				fill="none"
				preserveAspectRatio="none"
				...
				<g id="Group 281">
					...
					<g id="Group 233">
						<path
							d={svgPaths.p3324d9f0}
							fill="var(--fill-0, #B68CBB)"
							id="Vector_3"
						/>
						<path
							d={svgPaths.p2da48800}
							fill="var(--fill-0, #B68CBB)"
							id="Vector_4"
						/>
						<path
							d={svgPaths.p2c62d980}
							fill="var(--fill-0, #B68CBB)"
							id="Vector_5"
						/>
						<path
							d={svgPaths.p26330b00}
							fill="var(--fill-0, #B68CBB)"
							id="Vector_6"
						/>
						<path
						...
						/>
						<path
							d={svgPaths.p28555200}
							fill="var(--fill-0, #B68CBB)"
							id="Vector_9"
						/>
						<path
							d={svgPaths.p34831f80}
							fill="var(--fill-0, #B68CBB)"
							id="Vector_10"
						/>
						<path
						...
						/>
						<path
							d={svgPaths.p26080f00}
							fill="var(--fill-0, #B68CBB)"
							id="Vector_12"
						/>
						<path
							d={svgPaths.p3ab40400}
							fill="var(--fill-0, #B68CBB)"
							id="Vector_13"
						/>
						<g id="Group">
							...
							/>
							<path
								d={svgPaths.p14df72f0}
								fill="var(--fill-0, #F7E6D4)"
								id="Vector_21"
							/>
							<path
								d={svgPaths.p22154700}
								fill="var(--fill-0, #F7E6D4)"
								id="Vector_22"
							/>
							<path
								d={svgPaths.p1ac31600}
								fill="var(--fill-0, #F7E6D4)"
								id="Vector_23"
							/>
							<path
								d={svgPaths.p3b785f00}
								fill="var(--fill-0, #F7E6D4)"
								id="Vector_24"
							/>
						</g>
						<path
							d={svgPaths.p13a77900}
							fill="var(--fill-0, #A35380)"
							id="Vector_25"
						/>
						<g id="Group_2">
							...
							<g id="Vector_27" />
							<path
								d={svgPaths.p1239f100}
								fill="var(--fill-0, #D78228)"
								id="Vector_28"
							/>
							<path
								d={svgPaths.p367fe780}
								fill="var(--fill-0, #E0AF62)"
								id="Vector_29"
							/>
						</g>
						<g id="Group_3">
							...
							/>
							<path
								d={svgPaths.p1d42f400}
								fill="var(--fill-0, #E0AF62)"
								id="Vector_32"
							/>
							<path
								d={svgPaths.p2da3eb00}
								fill="var(--fill-0, #E0AF62)"
								id="Vector_33"
							/>
							<path
								d={svgPaths.p22baf880}
								fill="var(--fill-0, #E0AF62)"
								id="Vector_34"
							/>
							<path
								d={svgPaths.p1c82b600}
								fill="var(--fill-0, #E0AF62)"
								id="Vector_35"
							/>
							<path
							...
							/>
							<path
								d={svgPaths.p39ef0780}
								fill="var(--fill-0, #E0AF62)"
								id="Vector_37"
							/>
							<path
								d={svgPaths.p11ff8480}
								fill="var(--fill-0, #E0AF62)"
								id="Vector_38"
							/>
						</g>
						<g id="Group_4">
							<path
								d={svgPaths.p3172f780}
								fill="var(--fill-0, #85A687)"
								id="Vector_39"
							/>
							<path
								d={svgPaths.p241fce00}
								fill="var(--fill-0, #C2CE86)"
								id="Vector_40"
							/>
							<path
								d={svgPaths.p1d9c1400}
								fill="var(--fill-0, #C2CE86)"
								id="Vector_41"
							/>
							<path
								d={svgPaths.p2eca6180}
								fill="var(--fill-0, #C2CE86)"
								id="Vector_42"
							/>
							<path
								d={svgPaths.p2bab2480}
								fill="var(--fill-0, #C2CE86)"
								id="Vector_43"
							/>
							<path
						...
						<g id="Group_5">
							<path
								d={svgPaths.p23c1c400}
								fill="var(--fill-0, #85A687)"
								id="Vector_45"
							/>
							<path
								d={svgPaths.p2e079600}
								fill="var(--fill-0, #C2CE86)"
								id="Vector_46"
							/>
							<path
								d={svgPaths.p384e9f80}
								fill="var(--fill-0, #C2CE86)"
								id="Vector_47"
							/>
							<path
								d={svgPaths.p24e12ff2}
								fill="var(--fill-0, #C2CE86)"
								id="Vector_48"
							/>
							<path
...
function Capa2() {
	return (
		<div
			className="absolute h-[18.79px] left-[calc(50%+35px)] top-[426px] w-[26.57px]"
			data-name="Capa_1">
			<svg
				className="absolute block inset-0 size-full"
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 26.57 18.79">
						...
						<div className="flex-none rotate-90">
							<div
								...
								<svg
									...
									fill="none"
									preserveAspectRatio="none"
									viewBox="0 0 148.815 829.172">
									<path
										d={svgPaths.p34fecf00}
		...
		<div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
			<div className="col-1 flex h-[396px] items-center justify-center ml-0 mt-0 relative row-1 w-[640px]">
				<div className="-scale-y-100 flex-none">
					<div
						className="h-[396px] relative w-[640px]"
						data-name="Vector">
						<div className="absolute inset-[0_-3.13%_-10.1%_-3.13%]">
							<svg
								...
								viewBox="0 0 680 436">
								<g
									filter="url(#filter0_dd_28_4470)"
									id="Vector">
									<path
										d={svgPaths.p1a0b0430}
										fill="var(--fill-0, white)"
									/>
									<path
										d={svgPaths.pce05b00}
								...
								<defs>
									<filter
										...
										<feMorphology
											...
											operator="erode"
											radius="4"
											result="effect1_dropShadow_28_4470"
										/>
										<feOffset dy="8" />
										...
										<feMorphology
											...
											operator="erode"
											radius="4"
											result="effect2_dropShadow_28_4470"
										/>
										<feOffset dy="20" />
										...
										/>
										<feBlend
											in2="effect1_dropShadow_28_4470"
											mode="normal"
											result="effect2_dropShadow_28_4470"
										/>
										<feBlend
											in="SourceGraphic"
											in2="effect2_dropShadow_28_4470"
											mode="normal"
											result="shape"
										/>
									</filter>
	...
	return (
		<div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
			<div className="col-1 flex h-[422px] items-center justify-center ml-0 mt-0 relative row-1 w-[640px]">
				<div className="-scale-y-100 flex-none">
					<div
						className="h-[422px] relative w-[640px]"
						data-name="Vector">
						<div className="absolute inset-[0_-3.13%_-9.48%_-3.13%]">
							<svg
								...
								viewBox="0 0 680 462">
								<g
									filter="url(#filter0_dd_28_4466)"
									id="Vector">
									<path
										d={svgPaths.p2dc91d00}
										fill="var(--fill-0, white)"
									/>
									<path
										d={svgPaths.pa580a0}
								...
								<defs>
									<filter
										...
										<feMorphology
											...
											operator="erode"
											radius="4"
											result="effect1_dropShadow_28_4466"
										/>
										<feOffset dy="8" />
										<feGaussianBlur stdDeviation="4" />
										<feColorMatrix
										...
										<feMorphology
											...
											operator="erode"
											radius="4"
											result="effect2_dropShadow_28_4466"
										/>
										<feOffset dy="20" />
										<feGaussianBlur stdDeviation="12" />
										<feColorMatrix
										...
										/>
										<feBlend
											in2="effect1_dropShadow_28_4466"
											mode="normal"
											result="effect2_dropShadow_28_4466"
										/>
										<feBlend
											in="SourceGraphic"
											in2="effect2_dropShadow_28_4466"
											mode="normal"
											result="shape"
										/>
									</filter>
	...
	return (
		<div
			...
			<svg
				...
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 74.6966 81.4023">
				<g id="Group">
					<path
						d={svgPaths.p3ba265f0}
						fill="var(--fill-0, #D78228)"
						id="Vector"
					/>
					<path
						d={svgPaths.p13ec3400}
						fill="var(--fill-0, #C2CE86)"
						id="Vector_2"
					/>
					<path
						d={svgPaths.p29f7d200}
						fill="var(--fill-0, #E0AF62)"
						id="Vector_3"
					/>
					<path
						d={svgPaths.p3b548800}
						fill="var(--fill-0, #E0AF62)"
						id="Vector_4"
					/>
				</g>
...
function Capa6() {
	return (
		<div
			className="absolute h-[146px] left-[calc(75%-51px)] top-[659px] w-[209px]"
			data-name="Capa_1">
			<svg
				className="absolute block inset-0 size-full"
				fill="none"
...
function Testimonial() {
	return (
		<div
			...
			<div
				className="absolute flex h-[137.947px] items-center justify-center left-[calc(83.33%-39px)] top-[176px] w-[206.385px]"
				style={
					{
						"--transform-inner-width": "1185",
						"--transform-inner-height": "21",
			...
			<div
				className="absolute flex h-[203.64px] items-center justify-center left-[143px] top-[638px] w-[245.05px]"
				style={
					{
						"--transform-inner-width": "1185",
	...
	return (
		<div
			...
			<svg
				...
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 361.514 265.41">
				<g id="Group">
					<path
						d={svgPaths.p132ae700}
						fill="var(--fill-0, #1B1B1B)"
						id="Vector"
					/>
					<path
						d={svgPaths.p22564600}
						fill="var(--fill-0, #383838)"
						id="Vector_2"
					/>
					<path
						d={svgPaths.p23712600}
						fill="var(--fill-0, #383838)"
						id="Vector_3"
					/>
					<path
						d={svgPaths.p1acb9640}
						fill="var(--fill-0, #383838)"
						id="Vector_4"
					/>
					<path
						d={svgPaths.p3edae700}
						fill="var(--fill-0, #383838)"
						id="Vector_5"
					/>
					<path
						d={svgPaths.p3066b400}
						fill="var(--fill-0, #383838)"
						id="Vector_6"
					/>
					<path
						d={svgPaths.p271a3c80}
						fill="var(--fill-0, #383838)"
						id="Vector_7"
					/>
					<path
						d={svgPaths.p13e66a00}
						fill="var(--fill-0, #383838)"
						id="Vector_8"
					/>
				</g>
	...
	return (
		<div className="h-[350.48px] relative w-[240.979px]" data-name="Group">
			<svg
				...
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 240.979 350.48">
				<g id="Group">
					<path
						d={svgPaths.p39045580}
						fill="var(--fill-0, #1B1B1B)"
						id="Vector"
					/>
					<path
					...
					/>
					<path
						d={svgPaths.p1ddf1d00}
						fill="var(--fill-0, #383838)"
						id="Vector_3"
					/>
					<path
						d={svgPaths.p28a7e000}
						fill="var(--fill-0, #383838)"
						id="Vector_4"
					/>
					<path
						d={svgPaths.p39498470}
						fill="var(--fill-0, #383838)"
						id="Vector_5"
					/>
				</g>
	...
	return (
		<div className="h-[424.6px] relative w-[122.431px]" data-name="Group">
			<svg
				...
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 122.431 424.6">
				<g id="Group">
					<path
						d={svgPaths.p1cc19300}
						fill="var(--fill-0, #1B1B1B)"
						id="Vector"
					/>
					<path
						d={svgPaths.p29b2e040}
						fill="var(--fill-0, #383838)"
						id="Vector_2"
					/>
				</g>
	...
	return (
		<div className="h-[301.627px] relative w-[153.391px]" data-name="Group">
			<svg
				...
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 153.391 301.627">
				<g id="Group">
					<path
						d={svgPaths.p3dec7f00}
						fill="var(--fill-0, #1B1B1B)"
						id="Vector"
					/>
					<path
					...
					/>
					<path
						d={svgPaths.p31116a80}
						fill="var(--fill-0, #383838)"
						id="Vector_4"
					/>
					<path
						d={svgPaths.p19495c00}
						fill="var(--fill-0, #383838)"
						id="Vector_5"
					/>
				</g>
