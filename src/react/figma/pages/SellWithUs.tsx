...
import { Frame26, Frame27, Frame31, Frame35, Frame43, Group22, Group24, Group23 } from "../imports/SellWithUs-3/SellWithUs";
...
export default function SellWithUs() {
  return <div className="bg-white content-stretch flex flex-col items-center relative w-full min-h-screen" data-name="Sell with us">
			{/* Hero */}<div className="bg-white min-h-[600px] md:h-[1034px] overflow-clip relative shrink-0 w-full" data-name="Wireframe - 44">
			...
			<div className="absolute h-[36px] left-[6px] top-[124px] w-[633px]" data-name="objects" />
			...
			<div className="absolute h-[400px] md:h-[601px] -left-[100px] md:-left-[150px] top-[calc(20%-150px)] md:top-[calc(20%-163.5px)] w-[300px] md:w-[441px] opacity-30 md:opacity-100" data-name="Vector">
...
{/* Offering */}<div className="bg-white h-[1000px] overflow-clip relative shrink-0 w-full" data-name="Wireframe - 55">
			...
			<div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
				<div className="content-stretch flex gap-[32px] items-start relative shrink-0 w-full">
					{offeringRows[0].map(offering => <div className="bg-[#fbfafa] flex-[1_0_0] min-w-px relative rounded-[30px]">
			...
			<div className="content-stretch flex flex-col items-start max-w-[842px] relative shrink-0 w-full">
				<div className="content-stretch flex gap-[32px] items-start relative shrink-0 w-full">
					{offeringRows[1].map(offering => <div className="bg-[#fbfafa] flex-[1_0_0] min-w-px relative rounded-[30px]">
			<div className="content-stretch flex flex-col gap-[27px] items-start p-[48px] relative size-full">
				<offering.Header />
				<p className="font-['Rubik',sans-serif] font-normal leading-[1.68] min-w-full relative shrink-0 text-[#1e4a35] text-[16px] tracking-[0.48px] w-[min-content]">
					{offering.body}
...
{/* How it works */}<div className="bg-white min-h-[777px] overflow-clip relative shrink-0 w-full" data-name="Wireframe - 42">
			...
			<p className="font-['Fraunces',serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#0f251b] text-[56px] text-center tracking-[1.68px] w-full">
				How Does it Work
					...
					<div className="relative z-10 grid gap-6 pt-[170px] md:grid-cols-2 lg:grid-cols-4">
						{supplierProcessSteps.map((step, index) => <div className="flex gap-4 rounded-[24px] bg-white/90 p-5 shadow-sm">
			...
			<p className="font-['Rubik',sans-serif] font-normal leading-[1.68] not-italic text-[14px] text-black tracking-[0.42px]">
				{step.body}
					...
					<div className="absolute flex h-[148.815px] items-center justify-center left-[141px] top-[331.01px] w-[829.172px]" style={{
			...
			<div className="absolute h-[198.445px] left-[calc(66.67%+15px)] top-[248px] w-[203.707px]" data-name="Vector">
			...
			<div className="absolute flex inset-[43.21%_23.89%_49.39%_73.96%] items-center justify-center" style={{
                containerType: "size"
              }}>
			...
			<div className="absolute flex inset-[41.7%_24.86%_50.49%_72.29%] items-center justify-center" style={{
                containerType: "size"
              }}>
			...
			<div className="absolute flex inset-[48.72%_23.05%_47.84%_69.07%] items-center justify-center" style={{
                containerType: "size"
              }}>
...
{/* Supplier stories */}<div className="bg-[#f3f5e7] min-h-[840px] overflow-clip relative shrink-0 w-full" data-name="Testimonial">
        ...
        "--transform-inner-height": "252"
			...
			{supplierStories.map(StoryCard => <StoryCard key={StoryCard.name} />)}
		</div>
			</ContentContainer>
			<div className="absolute flex h-[137.947px] items-center justify-center left-[calc(83.33%-39px)] top-[176px] w-[206.385px]" style={{
        "--transform-inner-width": "1185",
        "--transform-inner-height": "21"
      } as React.CSSProperties}>
        ...
        containerType: "size"
			...
			<div className="absolute flex h-[203.64px] items-center justify-center left-[143px] top-[638px] w-[245.05px]" style={{
        "--transform-inner-width": "1185",
...
{/* CTA */}<div className="bg-white h-[695px] relative shrink-0 w-full" data-name="Wireframe - 36">
			<ContentContainer size="wide" className="flex justify-center pt-[87px]">
				<div className="bg-[#4c352b] min-h-[520px] max-w-[1216px] overflow-clip relative rounded-[40px] w-full flex items-center justify-center p-10" data-name="Wireframe - 38">
			...
			<div className="absolute bottom-0 flex h-[423.454px] items-center justify-center left-0 w-[381.093px]" style={{
              "--transform-inner-width": "1185",
              "--transform-inner-height": "21"
            } as React.CSSProperties}>
			...
			<div className="absolute flex h-[397.291px] items-center justify-center left-0 top-0 w-[375.304px]" style={{
              "--transform-inner-width": "1185",
              "--transform-inner-height": "21"
            } as React.CSSProperties}>
			...
			<div className="absolute flex h-[221.381px] items-center justify-center right-0 top-0 w-[329.65px]" style={{
              "--transform-inner-width": "1185",
              "--transform-inner-height": "21"
            } as React.CSSProperties}>
