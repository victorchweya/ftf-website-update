	...
	return (
		<div className="content-stretch flex flex-col gap-[40px] items-center not-italic relative shrink-0 text-center">
			...
			<p className="font-['Rubik',sans-serif] font-normal leading-[1.68] max-w-[488px] relative shrink-0 text-[#1e4a35] text-[20px] tracking-[0.6px] w-full">
				Connect directly with reliable, sustainable supply chains. From
				our farmers to your processing facilities worldwide.
			</p>
		</div>
	);
}
...
function Order() {
	return (
		<div
			className="absolute bg-[#1e4a35] content-stretch flex items-start left-[279px] px-[24px] py-[12px] rounded-[40px] top-[9px]"
			data-name="order">
	...
	return (
		<div className="bg-white h-[68px] relative rounded-[40px] shrink-0 w-[514px]">
			<div className="content-stretch flex gap-[8px] items-center overflow-clip px-[19px] py-[13px] relative rounded-[inherit] size-full">
				<CreditCard />
				<p className="flex-[1_0_0] font-['Rubik',sans-serif] font-normal leading-[1.5] min-w-px not-italic relative text-[#808080] text-[16px]">
					email@example.com
				</p>
				<Order />
			</div>
...
function GlobalBuyerHeroSection() {
	return (
		<div
			...
			<ContentContainer size="wide" className="pt-[214px]">
				<Frame24 />
			</ContentContainer>
			<Solution />
			<Header />
		...
		<div className="relative size-full">
			<svg
				...
				<g id="Group 44">
					<path
						d={svgPaths.pcdbb100}
						fill="var(--fill-0, #3E2B23)"
						id="Vector"
					/>
					<path
						d={svgPaths.p305f5a00}
						fill="var(--fill-0, #3E2B23)"
						id="Vector_2"
					/>
					<path
						d={svgPaths.p264b3100}
						fill="var(--fill-0, #3E2B23)"
						id="Vector_3"
					/>
					<path
						d={svgPaths.p39be5040}
						fill="var(--fill-0, #3E2B23)"
						id="Vector_4"
					/>
					<path
						d={svgPaths.p340be700}
						fill="var(--fill-0, #3E2B23)"
						id="Vector_5"
					/>
				</g>
		...
		<div className="h-[443.81px] relative w-[189.687px]" data-name="Group">
			<svg
				...
				<g id="Group">
					...
					/>
					<path
						d={svgPaths.p2aa07600}
						fill="var(--fill-0, #EAEAEA)"
						id="Vector_4"
					/>
					<path
						d={svgPaths.p35f94480}
						fill="var(--fill-0, #EAEAEA)"
						id="Vector_5"
					/>
					<path
						d={svgPaths.p2f91e000}
						fill="var(--fill-0, #EAEAEA)"
						id="Vector_6"
					/>
				</g>
...
function Frame31() {
	return (
		<div className="content-stretch flex flex-col gap-[40px] items-start not-italic relative w-full max-w-[525px]">
			<Frame22 />
			<p className="font-['Rubik',sans-serif] font-normal leading-[1.68] relative shrink-0 text-[16px] text-white tracking-[0.48px] w-[515px]">
				Farm to Feed works with farmers and local processors to bring
				Kenyan ingredients to global markets — while ensuring more value
				stays where the food is grown.
			</p>
		</div>
	);
}
...
function IngredientsOriginSection() {
	return (
		<div
			...
			<ContentContainer size="wide" className="relative z-10 pt-[51px]">
				<div className="grid gap-12 lg:grid-cols-2 lg:items-start">
					<Frame31 />
					<div className="relative h-[552px]">
						<div
							className="absolute flex h-[555.649px] items-center justify-center left-[40.82px] top-[61.68px] w-[574.366px]"
							style={
								{
									"--transform-inner-width": "1185",
									"--transform-inner-height": "21",
						...
						<div
							className="absolute h-[552px] left-0 top-0 w-[517px]"
							data-name="Vector">
							<img
								alt=""
								className="absolute block inset-0 max-w-none size-full"
...
function Frame38() {
	return (
		<div className="content-stretch flex flex-col gap-[32px] items-center max-w-[1052px] not-italic relative shrink-0 text-center w-full">
			...
			<p className="font-['Fraunces',serif] font-normal leading-[normal] min-w-full relative shrink-0 text-[#0f251b] text-[48px] tracking-[1.44px] w-[min-content]">
				Your Partner in Flavour
			</p>
			<p className="font-['Rubik',sans-serif] font-normal leading-[1.68] relative shrink-0 text-[#1e4a35] text-[16px] tracking-[0.48px] w-[718px]">
				With its rich agricultural diversity, Kenya offers exceptional
				potential for ingredient sourcing. We supply what you need.
			</p>
		</div>
	);
}
	...
	return (
		<div
			...
			<svg
				...
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 38.8817 67.6204">
				<g clipPath="url(#clip0_31_3181)" id="Isolation_Mode">
					<path
						d={svgPaths.p21ea8e40}
	...
	return (
		<div className="relative size-[85.228px]" data-name="Isolation_Mode">
			<svg
				...
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 85.2284 85.2284">
				<g clipPath="url(#clip0_31_3146)" id="Isolation_Mode">
					<path
						d={svgPaths.p2d058c00}
						fill="var(--fill-0, #4C352B)"
						id="Vector"
					/>
					<path
						d={svgPaths.p35d62e80}
						fill="var(--fill-0, #4C352B)"
						id="Vector_2"
					/>
				</g>
		...
		<div className="col-1 h-[24.995px] ml-[38.01px] mt-[39.76px] relative row-1 w-[25.702px]">
			<div className="absolute inset-[-1.2%_-1.17%]">
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 26.3017 25.5947">
					<g id="Group 168">
						<path
							d={svgPaths.p18776600}
							fill="var(--fill-0, #4C352B)"
							id="Vector"
		...
		<div
			...
			<svg
				...
				<g clipPath="url(#clip0_31_3218)" id="Isolation_Mode">
					...
					/>
					<path
						d={svgPaths.p30a1c3a0}
						fill="var(--fill-0, #4C352B)"
						id="Vector_2"
					/>
					<g id="Group 168">
						<path
							d={svgPaths.p2a4de780}
							fill="var(--fill-0, #4C352B)"
							id="Vector_3"
							stroke="var(--stroke-0, #4C352B)"
							strokeWidth="0.3"
...
function PartnerInFlavourSection() {
	return (
		<div
			...
			<ContentContainer size="wide" className="pt-[165px]">
				<Frame39 />
			</ContentContainer>
			<Order2 />
			<div
...
function Frame40() {
	return (
		<div className="content-stretch flex flex-col gap-[32px] items-center max-w-[1052px] not-italic relative text-center w-full">
			<p className="font-['Rubik',sans-serif] font-medium leading-[1.68] relative shrink-0 text-[#d78228] text-[16px] tracking-[0.48px] w-[718px]">
				We Connect It
			</p>
			<p className="font-['Fraunces',serif] font-normal leading-[normal] min-w-full relative shrink-0 text-[#0f251b] text-[48px] tracking-[1.44px] w-[min-content]">
			...
			<p className="font-['Rubik',sans-serif] font-normal leading-[1.68] relative shrink-0 text-[#1e4a35] text-[16px] tracking-[0.48px] w-[718px]">
				We build demand-driven supply chains. Our model matches your
				ingredient needs with reliable supply from our trusted network.
				We offer different product lines that harness dehydration and
				modern technology to capture peak season freshness.
			</p>
		</div>
	);
}
...
function Layer() {
	return (
		<div
			className="h-[240px] overflow-clip relative shrink-0 w-[271px]"
			data-name="Layer_1">
			<div
				...
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 234.337 239.996">
					<path
						d={svgPaths.p8a71c80}
						fill="var(--fill-0, #5B3711)"
						id="Vector"
					/>
				</svg>
			</div>
			<div
				className="absolute inset-[8.68%_1.39%_9.83%_0]"
				data-name="Rectangle">
	...
	return (
		<div className="content-stretch flex flex-col gap-[24px] items-start not-italic relative shrink-0 text-center w-full">
			<p className="font-['Fraunces',serif] font-normal leading-[normal] relative shrink-0 text-[#0f251b] text-[24px] tracking-[0.72px] w-full">
				Single-origin chilis, herbs, aromatics and more
			</p>
			<p className="font-['Rubik',sans-serif] font-normal leading-[1.68] relative shrink-0 text-[#1e4a35] text-[16px] tracking-[0.48px] w-full">
				Used for stand alone seasonings, blends, and creating
				high-quality flavor profiles for a wide range of formulations.
			</p>
		</div>
	);
}
		...
		<div
			...
			<div
				...
				<div className="absolute inset-0 overflow-hidden pointer-events-none">
					<img
						alt=""
						className="absolute left-[13.42%] max-w-none size-full top-[8.33%]"
						src={imgRectangle1}
					/>
				</div>
			</div>
...
function Frame2() {
	return (
		<div className="content-stretch flex flex-col gap-[24px] items-start not-italic relative shrink-0 text-center w-full">
			<p className="font-['Fraunces',serif] font-normal leading-[normal] relative shrink-0 text-[#0f251b] text-[24px] tracking-[0.72px] w-full">
				Leafy greens, roots, botanicals, and superfood-ingredients
			</p>
			<p className="font-['Rubik',sans-serif] font-normal leading-[1.68] relative shrink-0 text-[#1e4a35] text-[16px] tracking-[0.48px] w-full">
				Ideal for boosting nutrition, adding natural colour, and
				enhancing flavor in food, beverage, and nutraceutical
				applications.
			</p>
		</div>
	);
...
function Layer2() {
	return (
		<div
			...
			<div
				className="absolute inset-[18.75%_-0.18%_18.33%_24.17%]"
				data-name="Rectangle">
				<div className="absolute inset-0 overflow-hidden pointer-events-none">
					<img
						alt=""
...
function Frame3() {
	return (
		<div className="content-stretch flex flex-col gap-[24px] items-start not-italic relative shrink-0 text-center w-full">
			<p className="font-['Fraunces',serif] font-normal leading-[normal] relative shrink-0 text-[#0f251b] text-[24px] tracking-[0.72px] w-full">
				Crispy, tart tropical fruit flakes for snacks, cereals, dairy
				products and more
			</p>
			<p className="font-['Rubik',sans-serif] font-normal leading-[1.68] relative shrink-0 text-[#1e4a35] text-[16px] tracking-[0.48px] w-full">
		...
		<div
			...
			<div
				...
				<svg
					...
					<path
						d={svgPaths.p8a71c80}
						fill="var(--fill-0, #824266)"
						id="Vector"
					/>
				</svg>
			</div>
			<div
				className="absolute inset-[0_1.29%_0_-0.18%]"
				data-name="Rectangle">
				<div className="absolute inset-0 overflow-hidden pointer-events-none">
					<img
						alt=""
						className="absolute h-[111.35%] left-[0.19%] max-w-none top-[-6.25%] w-[99.72%]"
						src={imgRectangle3}
					/>
				</div>
			</div>
...
function Frame4() {
	return (
		<div className="content-stretch flex flex-col gap-[24px] items-start not-italic relative shrink-0 text-center w-full">
			<p className="font-['Fraunces',serif] font-normal leading-[normal] relative shrink-0 text-[#0f251b] text-[24px] tracking-[0.72px] w-full">
				Clean-label flours made from fruits, tubers, and vegetables
			</p>
			<p className="font-['Rubik',sans-serif] font-normal leading-[1.68] relative shrink-0 text-[#1e4a35] text-[16px] tracking-[0.48px] w-full">
				Suitable for grain-free and gluten-free formulations, baking,
				thickening, and functional ingredient development
			</p>
		</div>
	);
}
...
function Frame59() {
	return (
		<div className="content-stretch flex flex-col gap-[32px] items-center max-w-[1052px] not-italic relative text-center w-full">
			...
			<p className="font-['Rubik',sans-serif] font-normal leading-[1.68] relative shrink-0 text-[#1e4a35] text-[16px] tracking-[0.48px] w-[718px]">
				Our current batch is processed, certified, and ready for
				immediate global shipment to your facility.
			</p>
		</div>
	);
}
...
function SourcingProcessSection() {
	return (
		<div
			...
			<ContentContainer
				size="wide"
				className="flex flex-col items-center gap-[80px] pt-[50px]">
				<Frame40 />
				<Frame56 />
				<Frame59 />
			</ContentContainer>
	...
	return (
		<div className="content-stretch flex flex-col gap-[32px] items-center max-w-[1052px] not-italic relative shrink-0 text-center w-full">
			...
			<p className="font-['Rubik',sans-serif] font-normal leading-[1.68] relative shrink-0 text-[#1e4a35] text-[16px] tracking-[0.48px] w-[718px]">
				...
				ingredients meet international quality standards.
			</p>
		</div>
	);
}
...
function Layer4() {
	return (
		<div
			className="col-1 h-[39px] ml-[17px] mt-[13px] relative row-1 w-[35px]"
			data-name="Layer_1">
			<svg
				className="absolute block inset-0 size-full"
				fill="none"
				...
				<g clipPath="url(#clip0_31_3094)" id="Layer_1">
					...
					<g id="Group">
						...
						/>
						<path
							d={svgPaths.p324e8700}
							fill="var(--fill-0, #EFF6EF)"
							id="Vector_3"
							stroke="var(--stroke-0, #EFF6EF)"
							strokeWidth="0.2"
						/>
						<path
							d={svgPaths.p2cfcb400}
							fill="var(--fill-0, #EFF6EF)"
							id="Vector_4"
							stroke="var(--stroke-0, #EFF6EF)"
							strokeWidth="0.2"
		...
		<div className="bg-[#f7f7f7] flex-[1_0_0] min-w-px relative rounded-[30px]">
			<div className="content-stretch flex flex-col gap-[27px] items-start p-[48px] relative size-full">
				...
				<p className="font-['Rubik',sans-serif] font-normal leading-[1.68] min-w-full not-italic relative shrink-0 text-[#1e4a35] text-[16px] tracking-[0.48px] w-[min-content]">
					Strict processing and quality control standards applied
					across the chain. Fully HACCP and ISO standard compliant.
				</p>
			</div>
		</div>
	);
...
function Group4() {
	return (
		<div
			className="absolute inset-[0_23.51%_0_0] mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[0.001px_-0.001px] mask-size-[33.312px_31px]"
			...
			<svg
				...
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 32.8904 30.9992">
				<g id="Group">
					<path
						d={svgPaths.p13d38d00}
						fill="var(--fill-0, #EFF6EF)"
						id="Vector"
					/>
				</g>
...
function ClipPathGroup() {
	return (
		<div
			className="absolute contents inset-[0_22.53%_0_0]"
...
function Group5() {
	return (
		<div
			className="absolute inset-[23.45%_40.48%_21.17%_17.43%]"
			data-name="Group">
			<svg
				className="absolute block inset-0 size-full"
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 18.0969 17.1696">
				<g id="Group">
					<path
						d={svgPaths.p397bc800}
						fill="var(--fill-0, #EFF6EF)"
						id="Vector"
					/>
					<path
						d={svgPaths.p20345100}
						fill="var(--fill-0, #EFF6EF)"
						id="Vector_2"
						stroke="var(--stroke-0, #EFF6EF)"
						strokeWidth="0.2"
...
function Layer5() {
	return (
		<div
			className="col-1 h-[31px] ml-[14.67px] mt-[18px] overflow-clip relative row-1 w-[43px]"
			data-name="Layer_1">
			<ClipPathGroup />
			<div
				className="absolute inset-[46.64%_0_10.63%_60.03%]"
				data-name="Vector">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 17.1868 13.2462">
					<path
						d={svgPaths.p2b3e7640}
						fill="var(--fill-0, #EFF6EF)"
						id="Vector"
					/>
				</svg>
	...
	return (
		<div className="bg-[#f7f7f7] flex-[1_0_0] min-w-px relative rounded-[30px]">
			<div className="content-stretch flex flex-col gap-[27px] items-start p-[48px] relative size-full">
				<Frame53 />
				<p className="font-['Rubik',sans-serif] font-normal leading-[1.68] min-w-full not-italic relative shrink-0 text-[#1e4a35] text-[16px] tracking-[0.48px] w-[min-content]">
					Every batch is meticulously selected for its optimal flavour
					profile, vibrant aroma, and rich, natural colour.
				</p>
			</div>
		</div>
	);
...
function IsolationMode3() {
	return (
		<div
			className="h-[30.084px] relative w-[17.298px]"
			data-name="Isolation_Mode">
			<svg
				className="absolute block inset-0 size-full"
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 17.2982 30.0839">
				<g clipPath="url(#clip0_31_3056)" id="Isolation_Mode">
					<path
						d={svgPaths.p1b581c00}
						fill="var(--fill-0, #FBFAFA)"
						id="Vector"
					/>
					<path
						d={svgPaths.p27bb6e40}
						fill="var(--fill-0, #FBFAFA)"
						id="Vector_2"
					/>
				</g>
...
function Group33() {
	return (
		<div className="col-1 grid-cols-[max-content] grid-rows-[max-content] h-[34.697px] inline-grid ml-[0.05px] mt-[9.67px] place-items-start relative row-1 w-[29.684px]">
			<div
				className="col-1 flex h-[34.697px] items-center justify-center ml-0 mt-0 relative row-1 w-[29.684px]"
				style={
					{
						"--transform-inner-width": "1185",
						"--transform-inner-height": "21",
...
function Group32() {
	return (
		<div className="col-1 grid-cols-[max-content] grid-rows-[max-content] h-[43.186px] inline-grid ml-[16.72px] mt-[10.63px] place-items-start relative row-1 w-[34.402px]">
			<Group33 />
			<div
				className="col-1 flex h-[12.091px] items-center justify-center ml-0 mt-0 relative row-1 w-[13px]"
				style={
					{
						"--transform-inner-width": "1185",
						"--transform-inner-height": "21",
				...
				<div className="flex-none rotate-[23.25deg]">
					<div
						className="h-[8.684px] relative w-[10.418px]"
						data-name="Vector">
						<svg
							className="absolute block inset-0 size-full"
							fill="none"
							preserveAspectRatio="none"
							viewBox="0 0 10.418 8.68404">
							<path
								d={svgPaths.p24a6d480}
								fill="var(--fill-0, #FBFAFA)"
								id="Vector"
							/>
						</svg>
	...
	return (
		<div className="bg-[#f7f7f7] flex-[1_0_0] min-w-px relative rounded-[30px]">
			<div className="content-stretch flex flex-col gap-[27px] items-start p-[48px] relative size-full">
				<Frame55 />
				<p className="font-['Rubik',sans-serif] font-normal leading-[1.68] min-w-full not-italic relative shrink-0 text-[#1e4a35] text-[16px] tracking-[0.48px] w-[min-content]">
					Our digital sourcing systems allow every single ingredient
					to be accurately traced directly back to its farm of origin.
				</p>
			</div>
		</div>
	);
...
function QualitySection() {
	return (
		<div
			...
			<ContentContainer size="wide" className="pt-[178px]">
				<Frame42 />
			</ContentContainer>
			<Order3 />
...
function Frame57() {
	return (
		<div className="content-stretch flex flex-col gap-[32px] items-start max-w-[737px] not-italic relative w-full">
			<p className="font-['Rubik',sans-serif] font-medium leading-[1.68] relative shrink-0 text-[#d78228] text-[15px] tracking-[0.45px] w-[624px]">
				You bring it to the World
			</p>
			<p className="font-['Fraunces',serif] font-normal leading-[normal] min-w-full relative shrink-0 text-[#0f251b] text-[48px] tracking-[1.44px] w-[min-content]">
				Sourcing that strengthens the food system.
			</p>
			<p className="font-['Rubik',sans-serif] font-normal leading-[1.68] relative shrink-0 text-[#1e4a35] text-[20px] tracking-[0.6px] w-[624px]">
				Our ingredients contribute to a more resilient and sustainable
				global food system. We operate on six core impact principles.
			</p>
		</div>
	);
}
		...
		<div className="col-1 h-[48px] ml-0 mt-0 relative row-1 w-[49.358px]">
			<div className="absolute inset-[-0.63%_-0.61%_-0.62%_-0.61%]">
				<svg
					...
					fill="none"
					preserveAspectRatio="none"
					viewBox="0 0 49.9577 48.6">
					<g id="Group 193">
						<path
							d={svgPaths.p370d6a00}
							fill="var(--fill-0, #AC6820)"
							id="Vector"
							stroke="var(--stroke-0, #AC6820)"
							strokeWidth="0.3"
						/>
						<path
							d={svgPaths.p38f04b00}
							fill="var(--fill-0, #AC6820)"
							id="Vector_2"
							stroke="var(--stroke-0, #AC6820)"
							strokeWidth="0.2"
...
function Frame64() {
	return (
		<div className="content-stretch flex flex-[1_0_0] flex-col gap-[27px] items-start min-w-px not-italic relative">
			...
			<p className="font-['Rubik',sans-serif] font-normal leading-[1.68] relative shrink-0 text-[#1e4a35] text-[16px] tracking-[0.48px] w-full">
				Suited to changing weather patterns, ensuring reliable yield and
...
function Group7() {
	return (
		<div
			className="h-[47.32px] relative shrink-0 w-[78.899px]"
			data-name="Group">
			<svg
				className="absolute block inset-0 size-full"
				fill="none"
				preserveAspectRatio="none"
				viewBox="0 0 78.8991 47.3202">
				<g id="Group">
					<path
						d={svgPaths.p1c9cff00}
						fill="var(--fill-0, #AC6820)"
						id="Vector"
					/>
					<path
					...
					/>
					<path
						d={svgPaths.p2247e040}
						fill="var(--fill-0, #AC6820)"
						id="Vector_3"
					/>
					<path
						d={svgPaths.p2f75a900}
						fill="var(--fill-0, #AC6820)"
						id="Vector_4"
					/>
					<path
						d={svgPaths.p2d7a7f80}
						fill="var(--fill-0, #AC6820)"
						id="Vector_5"
					/>
				</g>
...
function Frame67() {
	return (
		<div className="content-stretch flex flex-[1_0_0] flex-col gap-[27px] items-start min-w-px not-italic relative">
			...
			<p className="font-['Rubik',sans-serif] font-normal leading-[1.68] relative shrink-0 text-[#1e4a35] text-[16px] tracking-[0.48px] w-full">
				Practices that actively protect soil health and minimize harmful
				chemical inputs.
			</p>
		</div>
	);
...
function Frame73() {
	return (
		<div className="content-stretch flex flex-[1_0_0] flex-col gap-[27px] items-start min-w-px not-italic relative">
			...
			<p className="font-['Rubik',sans-serif] font-normal leading-[1.68] relative shrink-0 text-[#1e4a35] text-[16px] tracking-[0.48px] w-full">
				Directly connecting surplus and imperfect harvests to viable
				processing markets.
			</p>
		</div>
	);
		...
		<div className="h-[72px] relative shrink-0 w-[53px]" data-name="Capa_1">
			<svg
				...
				<g clipPath="url(#clip0_31_3104)" id="Capa_1">
					<path
						d={svgPaths.p37da7180}
						fill="var(--fill-0, #AC6820)"
						id="Vector"
					/>
					<path
						d={svgPaths.p13c02d80}
						fill="var(--fill-0, #AC6820)"
						id="Vector_2"
					/>
					<path
						d={svgPaths.p3c1df500}
						fill="var(--fill-0, #AC6820)"
						id="Vector_3"
					/>
					<path
						d={svgPaths.p2eea8a80}
						fill="var(--fill-0, #AC6820)"
						id="Vector_4"
					/>
					<path
						d={svgPaths.p1e016a00}
						fill="var(--fill-0, #AC6820)"
						id="Vector_5"
					/>
					<path
						d={svgPaths.p3b188d80}
						fill="var(--fill-0, #AC6820)"
						id="Vector_6"
					/>
					<path
						d={svgPaths.p38c1a380}
						fill="var(--fill-0, #AC6820)"
						id="Vector_7"
					/>
				</g>
...
function Frame76() {
	return (
		<div className="content-stretch flex flex-[1_0_0] flex-col gap-[27px] items-start min-w-px not-italic relative">
			...
			<p className="font-['Rubik',sans-serif] font-normal leading-[1.68] relative shrink-0 text-[#1e4a35] text-[16px] tracking-[0.48px] w-full">
				Providing better, more consistent market access and fairer
				pricing structures.
			</p>
		</div>
	);
...
function Frame80() {
	return (
		<div className="content-stretch flex flex-[1_0_0] flex-col gap-[27px] items-start min-w-px not-italic relative">
			...
			<p className="font-['Rubik',sans-serif] font-normal leading-[1.68] relative shrink-0 text-[#1e4a35] text-[16px] tracking-[0.48px] w-full">
				Supporting healthier global diets with nutrient-dense,
...
function Frame79() {
	return (
		<div className="content-stretch flex gap-[27px] items-center relative shrink-0 w-full">
			<div
				className="h-[72px] relative shrink-0 w-[74px]"
				data-name="Vector">
				<svg
					className="absolute block inset-0 size-full"
					fill="none"
...
function IsolationMode4() {
	return (
		<div
			className="h-[72px] relative shrink-0 w-[76px]"
			data-name="Isolation_Mode">
			<svg
				className="absolute block inset-0 size-full"
				fill="none"
...
function Frame83() {
	return (
		<div className="content-stretch flex flex-[1_0_0] flex-col gap-[27px] items-start min-w-px not-italic relative">
			...
			<p className="font-['Rubik',sans-serif] font-normal leading-[1.68] relative shrink-0 text-[#1e4a35] text-[16px] tracking-[0.48px] w-full">
				Processing highly perishable raw crops into stable, long-lasting
				export ingredients
			</p>
		</div>
	);
...
function ImpactPrinciplesSection() {
	return (
		<div
			...
			<ContentContainer
				size="wide"
				className="flex flex-col gap-[96px] pt-[96px]">
				<Frame57 />
				<Frame58 />
			</ContentContainer>
		</div>
...
function Order4() {
	return (
		<div
			className="absolute bg-[#d78228] content-stretch flex items-start left-[279px] px-[24px] py-[12px] rounded-[40px] top-[9px]"
			data-name="order">
