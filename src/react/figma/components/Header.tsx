...
function Group() {
	return (
		<div
			className="h-[28px] relative shrink-0 w-[191.825px]"
			data-name="Group">
			<svg
...
export function Header() {
	return (
		<div
			className="absolute left-0 right-0 top-[32px] z-30"
			data-name="header">
			<ContentContainer size="wide" className="px-4 sm:px-6 lg:px-10">
				<div
					className="bg-[#fefcf5] flex items-center justify-between px-[20px] py-[20px] relative rounded-[54px] shrink-0 w-full sm:px-[32px]"
					data-name="header">
					<Link to="/">
						<Group />
					</Link>
